...
#Recovery templates.
$Queryt = "SELECT ds_encabezado_de,ds_cuerpo_de FROM k_template_doc WHERE fl_template=222 ";
        ...
        <div class="col-md-12">
            <div id="js-clock" class="row js-clock">
                <div class="col-md-3 box-2">
                    <div id="js-clock-days" class="clock-number-2">00</div><div class="clock-label-2">Tage</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-hours" class="clock-number-2">00</div><div class="clock-label-2">Std</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-minutes" class="clock-number-2">00</div><div class="clock-label-2">Min</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-seconds" class="clock-number-2">00</div><div class="clock-label-2">SekS</div>
                </div>
            </div>
        </div>
    </div>
