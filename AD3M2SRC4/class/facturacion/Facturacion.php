...
//        Dbg::pd($ImpuestosComprobante);
        ...
        /**
         * EGMC 20151214
         * Se genera el sello y se asignan los atriburos $sello y $cadenaOriginal
         */
        $Comprobante->setSello($this->_getSello($Comprobante, $data['Emisor']['Certificados']));
        $dataResult['cadenaOriginal'] = $this->cadenaOriginal;
        $dataResult['sello'] = $this->sello;
        /**
        ...
        /**
         * EGMC 20151214
         * Sólo valida que el RFC del Receptor no esté vacio
         */
...
//                $privateKeyId = openssl_get_privatekey($privateKey, '12345678a');
                $privateKeyId = openssl_get_privatekey($privateKey, $certificados['passwordPrivateKey']);
