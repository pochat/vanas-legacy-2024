<?php
  ...
  if(!ValidaPermiso(FUNC_TEACHER_RATE, PERMISO_EJECUCION)) {
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_ETIQUETAS; ?>">	
                  </div>
                  <!-- end widget edit box -->
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    function busqueda_teacher(instituto,programa){
        ...
        $.ajax({
            type: 'POST',
            url: 'div_dialogo_busqueda_tarifas.php',
            async: false,
