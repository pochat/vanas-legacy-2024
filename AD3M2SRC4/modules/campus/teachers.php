<?php
  ...
  $Query .= "ELSE '".ObtenEtiqueta(NO_ETQ_NO)."' END '".ObtenEtiqueta(113)."|center', mn_hour_rate 'Rate Lecture' , mn_hour_rate_group_global 'Rate Review',mn_hour_rate_global_class 'Rate Global Class'  ";
  ...
  $campos = array(ETQ_USUARIO, ETQ_NOMBRE, ObtenEtiqueta(110), ObtenEtiqueta(111), ObtenEtiqueta(112),'Rate Lecture','Rate Review');
  PresentaPaginaListado(FUNC_MAESTROS, $Query, TB_LN_IUD, True, True, $campos);
