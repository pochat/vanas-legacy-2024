                  ...
                  <div role="menu" class="widget-toolbar">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          ...
                          <li>
                              <a href="javascript:enrollstudent();"><i class="fa fa-user">&nbsp;</i><?php echo ObtenEtiqueta(345); ?></a>                              
                          </li>
                          <li>
...
<script type="text/javascript">
    ...
    function editComments(fl_sesion) {
       
        
        document.getElementById('btn_save' + fl_sesion).style.display = "inline";
        document.getElementById('btn_edit' + fl_sesion).style.display = "none";
        document.getElementById('comments_'+fl_sesion).disabled = false;

    }
    function saveComments(fl_sesion) {

        document.getElementById('btn_save' + fl_sesion).style.display = "none";
        document.getElementById('btn_edit' + fl_sesion).style.display = "inline";
        document.getElementById('comments_' + fl_sesion).disabled = true;

        var comments = document.getElementById('comments_' + fl_sesion).value;


        $.ajax({
            type: 'POST',
            url: 'save_comments.php',
            data: 'fl_sesion=' + fl_sesion +
                  '&comments=' + comments,
            async: true,
