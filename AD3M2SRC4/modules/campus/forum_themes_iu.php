...
<script>
  ...
  if(!empty($clave)) {
    ...
    $Query .= "SET nb_tema='$nb_tema', no_orden=$no_orden, ds_ruta_imagen='$ds_ruta_imagen' ";
    $Query .= "WHERE fl_tema = $clave";
  }
  else {
    $Query  = "INSERT INTO c_f_tema (nb_tema, no_orden, ds_ruta_imagen) ";
    $Query .= "VALUES('$nb_tema', $no_orden, '$ds_ruta_imagen')";
	}
	EjecutaQuery($Query);
