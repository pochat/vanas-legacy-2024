<?php
  ...
  # Libreria de funciones
	...
	$fg_visible = RecibeParametroHTML('fg_aplictionse');
	$_POST[''];
	
	if($fg_visible==1){
		
		$Query="UPDATE c_sesion SET fg_confirmado='1' WHERE fl_sesion=$clave ";
		EjecutaQuery($Query);
  ...
  $Query.=" nb_name_institutcion='$nb_name_institutcion',fe_expirity_date=$fe_expirity_date, fe_start_date=$fe_start_date , ";
