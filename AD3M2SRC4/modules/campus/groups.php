<?php
  ...
  if(!ValidaPermiso(FUNC_GRUPOS, PERMISO_EJECUCION)) {
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_GRUPOS; ?>">	                      
                  </div>
                  <!-- end widget edit box -->                  
                  <!-- widget content -->
                          ...
                          <thead>
                              <tr>
                                 <th></th>
                                  ...
                                  <th><?php echo ObtenEtiqueta(381); ?></th>
                                  <th><?php echo ObtenEtiqueta(375); ?></th>
                                  <th><?php echo ObtenEtiqueta(420); ?></th>
								  <th><?php echo ObtenEtiqueta(421); ?></th>
								  <th><?php echo ObtenEtiqueta(423); ?></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      function busqueda(instituto,programa){
        ...
        $.ajax({
            type: 'POST',
            url: 'div_dialogo_busqueda_groups.php',
            async: false,
      ...
      .DataTable({                    
          ...
          "columns": [
              ...
              { "data": "name" },
              { "data": "nb_periodo" },
              { "data": "grado" ,"class": 'text-align-center'},
              { "data": "grupo"},
			   { "data": "teacher"},
			   { "data": "student","class":'text-align-center'},
