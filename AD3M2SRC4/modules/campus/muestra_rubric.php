...
textarea.form-control {
   ...
   <div class="modal-header">
		  ...
		  <center><h4 class="modal-title"><i class='fa fa-table' aria-hidden='true'></i> <b>Rubric: </b><?php echo $nb_programa ?></h4></center>
	</div>
	<div class="modal-body">
		  <div class="row">
			...
			<!---
			 <?php //echo //PresentaRubric($fl_programa,$cl_sesion,'','','',true); ?>
			 ---->
																    ...
																    <div class='panel panel-default' style='height:424px;'>
																	   <div class='panel-body text-center'  id='divborder_cero_<?php echo $fl_criterio."_".$contador_border; ?> '>
																			<span  style='color:#8FCAE5;font-size:15px; '><?php echo $ds_equivalencia ?> </span>  <p>&nbsp;</p>
																			 ...
																			 <div class='chart ' data-percent='<?php echo $no_max;?>' id='easy-pie-chart<?php echo $contador;?>'>
											        ...
											        <div class='col-md-2' style='padding-left: 3px;padding-right: 3px;'>
															...
															<div class='panel panel-default' style='height:424px;'>
																<div class='panel-body text-center'>
																	...
																	<div class='form-group'>
																		<span id='char<?php echo $cont1;?>' name='char<?php echo $cont;?>' class='pull-left text-left hidden'> </span>
