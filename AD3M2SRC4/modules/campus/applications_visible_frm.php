<?php
  ...
  $Query .=",a.fg_disability,a.ds_disability,a.ds_ruta_foto_permiso,".ConsultaFechaBD('a.fe_start_date',FMT_FECHA)." fe_start_date, ".ConsultaFechaBD('a.fe_expirity_date',FMT_FECHA)." fe_expirity_date ,nb_name_institutcion ";
 ...
 $fl_class=$rowc[1];
  ...
  if(!$fg_error) { // Sin error, viene del listado
    if(!empty($cl_sesion)) { // Actualizacion, recupera de la base de datos
      ...
      $Query .= ", c.ds_citizenship, c.fg_study_permit, c.fg_study_permit_other, c.fg_aboriginal, c.ds_aboriginal, c.fg_health_condition, c.ds_health_condition ";
                ...
                <div id="myTabContent1" class="tab-content padding-10 no-border">
                  <div class="tab-pane fade in active" id="student">
                         ...
                         ?>
                          ...
                          for($i=1; $i<=$contratos; $i++) {
                            ...
                            <li class="sparks-info " style="max-height:60px;">
                                ...
                                --->
                                <small class="text-success"><a class="btn btn-primary" onclick="javascript:MostrarAplicaciones(1);"> Show in Applications</a></small>
						        <input type="hidden" name="fg_aplictionse" id="fg_aplictionse" >
                            </li>
                    ...
                    <div class="col col-xs-12 col-sm-10 col-lg-12">
                      ...
                      <div class="row">
                        ...
                        Forma_CampoSelectBD(ObtenEtiqueta(877), False, 'cl_recruiter', $Query, $cl_recruiter, $cl_recruiter_err, True, '', 'left', 'col col-sm-12', 'col col-sm-12');
                        ?>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col col-xs-12 col-sm-10 col-lg-12">
                      <div class="row">
                        <div class="col col-xs-12 col-sm-4">
                        <?php
                        Forma_CampoTexto(ObtenEtiqueta(117), True, 'ds_fname', $ds_fname, 20, 20, $ds_fname_err, False, '', True, 'onkeypress=\'return validarnspace(event)\'', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                        ?>
                        </div>
                        <div class="col col-xs-12 col-sm-4">
                        <?php
                        Forma_CampoTexto(ObtenEtiqueta(119), False, 'ds_mname', $ds_mname, 20, 20,'', False, '', True, 'onkeypress=\'return validarnspace(event)\'', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                        ?>
                        </div>
                        <div class="col col-xs-12 col-sm-4">
                        <?php
                        Forma_CampoTexto(ObtenEtiqueta(118), True, 'ds_lname', $ds_lname, 20, 20, $ds_lname_err, False, '', True, 'onkeypress=\'return validarnspace(event)\'', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ...
                      <div class="row">
                        ...
                        <?php
                        $ruta = PATH_ALU_IMAGES."/id";                        
                        Forma_CampoUpload(ObtenEtiqueta(810), '', 'ds_ruta_foto', $ds_ruta_foto,$ruta,True,'ds_ruta_foto',60, $ds_ruta_foto_err, 'jpg|jpeg', '', 'left', 'col col-sm-12 col-lg-12 col-xs-12 col-md-12', 'col col-sm-12 col-lg-12');                       
                        ?>
                        </div>
                        <div class="col col-xs-12 col-sm-4">
                        <?php
                      ...
                      <div class="row">
                        ...
                        <div class="col col-xs-12 col-sm-4">
                        <?php
                        Forma_CampoTexto(ObtenEtiqueta(280), True, 'ds_number', $ds_number, 20, 20, $ds_number_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                        ?>
                        </div>
                        <div class="col col-xs-12 col-sm-4">
                        <?php
                      ...
                      <div class="row">                        
                        ...
                        <div class="col col-xs-12 col-sm-4">
                        <?php
                        Forma_CampoTexto(ObtenEtiqueta(339),False,'ds_link_to_portfolio', $ds_link_to_portfolio, 255, 40,'', False, '', True, '', '', "form-group", 'left', 'col col-sm-12 col-md-12 col-lg-12 col-xs-12', 'col col-sm-12');
                        ?>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col col-xs-12 col-sm-4">
                        <?php
                        Forma_CampoTexto(ObtenEtiqueta(120),True,'fe_birth',$fe_birth,10,10, $fe_birth_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ...
                      <div class="row">
                      <div class="col-xs-12 col-sm-5 no-padding padding-bottom-10">
                        <?php                        
                        Forma_CampoCheckbox('','fg_international',$fg_international, ObtenEtiqueta(620), '', True, " onClick='javascript:mostrar_ocultar(1);'", 'left', 'col-sm-12 no-padding', 'col-sm-12 no-padding');
                        ?>
                      </div>
					  ...
					  <div class="row "   id="permisso">
						  <div class="col-xs-12 col-sm-3">
							<?php 
								Forma_CampoTexto(ObtenEtiqueta(2180),True,'fe_start_date',$fe_start_date,10,10, $fe_start_date_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
						  ...
						  <div class="col-xs-12 col-sm-3">
							 <?php 
								...
								Forma_CampoTexto(ObtenEtiqueta(2181),True,'fe_expirity_date',$fe_expirity_date,10,10, $fe_expirity_date_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
						  ...
						  <div class="col-xs-12 col-sm-6">
							 <?php
								...
								Forma_CampoTexto(ObtenEtiqueta(2182),True,'nb_name_institutcion',$nb_name_institutcion, 50,0, $nb_name_institutcion_err, False, 'nb_name_institutcion', $nb_name_institutcion, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
						  ...
						  <div class="row" id="photo_permiso">
							  ...
							  <div class="col-xs-12 col-sm-4">
								<?php 
									...
									Forma_CampoUpload(ObtenEtiqueta(2183), '', 'ds_ruta_foto_permiso', $ds_ruta_foto_permiso,$ruta_permiso,True,'ds_ruta_foto_permiso',60, $ds_ruta_foto_permiso_err, 'jpg|jpeg', '', 'left', 'col col-sm-12 col-lg-12 col-xs-12 col-md-12', 'col col-sm-12 col-lg-12');                       
                    ...
                    <div class="col col-xs-12 col-sm-10 col-lg-12">
                      ...
                      <div class="row">
                        ...
                        if($fg_health_condition ==1)
                          ...
                          $health = False;                        
                        Forma_CampoTexto(ObtenEtiqueta(1033),True,'ds_health_condition',$ds_health_condition, 50,0, $ds_health_condition_err, False, 'fg_health', $health, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                        ?>
                        </div>
                      </div>
                          ...
                          <div class="row">
                            ...
                            if($fg_disabilityie ==1)
                                ...
                                $disability  = False;                        
                            Forma_CampoTexto(ObtenEtiqueta(1779),True,'ds_disability',$ds_disability, 50,0, $ds_disability_err, False, 'fg_disability', $disability, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                            ?>
                            </div>
                          </div>
							...
							<div class="row">
								<div class="col-sm-12 no-padding text-right">
                                     ...
                                     function CampoCheckbox2($p_nombre, $p_valor, $p_texto='', $p_regresa='', $p_editar=True, $p_script='') {
                                         ...
                                         echo "<span style='margin-right:22px;'>$p_texto</span><input class='checkbox' type='checkbox' id='$p_nombre' name='$p_nombre'";
                  ...
                  <table border='".D_BORDES."' width='100%' cellpadding='3' cellspacing='0' class='table table-striped table-hover dataTable no-footer has-columns-hidden'>    
                    ...
                    <tr class='css_tabla_detalle'>
                      <td align='left' style='font-weight:bold'>".ObtenEtiqueta(582)."</td>
                      <td align='left'>&nbsp;</td>
                  ...
                  echo "
                    ...
                    <tr class='css_tabla_detalle'>
                      ...
                      <td align='left'>";
                      echo "<div class='row form-group'><div class='input col col-sm-10 col-sm-offset-1 padding-top-10'>";
                  CampoTexto('ds_descuento', $ds_descuento, 50, 25, 'form-control');
                  echo "</div></div>";
                  echo "
                      </td>
                      <td align='right'>";
                                  ...
                                  <div class="widget-body" style="min-height:0; padding-bottom: 0px;">
                                      <div class="row">
                                          ...
                                          <div class="row padding-bottom-10">
											...
											<div class="col-sm-4">
                                              <?php echo 
											  Forma_CampoSelect(ObtenEtiqueta(2389), True, 'fl_class_time', $opc, $val, $fl_class_time, $fl_class_time_err, True, '', 'left', 'col col-sm-12', 'col col-sm-12');
