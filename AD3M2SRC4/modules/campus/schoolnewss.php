                      ...
                      <table id="tbl_schoolnews" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                          <thead>
                              <tr>
                                ...
                                <th data-class="expand"><i class="fa fa-fw fa-cubes text-muted hidden-md hidden-sm hidden-xs"></i><?php echo ObtenEtiqueta(45); ?></th>
...
<!-- btn add -->
 <div style="width: 228px; right: 0px; display: block; padding:0px 50px 10px 0px;" outline="0" class="ui-widget ui-chatbox">
  <a href="javascript:Envia('schoolnewss_frm.php', '');" class="btn btn-primary btn-circle btn-xl" title="Add record" style="color:#FFFFFF;"><i class="fa fa-plus"></i></a>
</div>
    ...
    // clears the variable if left blank
      var table = $('#tbl_schoolnews').on( 'processing.dt', function ( e, settings, processing ) {
        ...
        // alert(processing);
          ...
          "ajax": "schoolnewss_list.php",
          //"serverSide": true,
          "processing": true,
          "bDestroy": true,
        "columns": [
              { "data": "datepublisher", "orderable": true, "type": "date"},
              { "data": "title" },
