<?php
  ...
  # Obtiene la informacion de un mes atras para delante
  $Query .= " AND a.fe_entregado>=DATE_SUB( CURDATE(), INTERVAL 3 MONTH) ";
  $Query .= "ORDER BY nb_programa, d.no_grado, no_semana, a.fe_entregado DESC, nb_grupo";
