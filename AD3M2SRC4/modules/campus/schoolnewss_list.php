...
?>
{
    ...
    for($i=1;$row=RecuperaRegistro($rs);$i++){
      ...
      echo '
        {            
            "datepublisher": "<a href=\'javascript:Envia(\"schoolnewss_frm.php\",'.$fl_blog.');\'>'.$fe_blog.'</a>",
            "title": "<td><a href=\'javascript:Envia(\"schoolnewss_frm.php\",'.$fl_blog.');\'>'.str_texto($ds_titulo).'</a></td>",
            ...
            "view": " '.$no_hits.' ",
            "delete": "<a class=\'btn btn-xs btn-default\' title=\'Delete\' href=\'javascript:Borra(\"schoolnewss_del.php\",'.$fl_blog.');\'><i class=\'fa fa-trash-o\'></i></a>"
        }';
      if($i<=($registros-1))
        echo ",";
      else
