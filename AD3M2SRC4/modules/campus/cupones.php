<?php
  ...
  if(!ValidaPermiso(FUNC_CUPON, PERMISO_EJECUCION)) {
        ...
        <div class="col-xs-12 col-sm-12" style="padding: 3px">
          ...
          <div role="widget" class="jarviswidget" id="widget-grid-1" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              <header role="heading">
                  ...
                  <h2><?php echo ObtenEtiqueta(2274); ?> </h2>
              </header>
              <!-- widget div-->
              <div role="content">
                  <!-- widget edit box -->
                  ...
                  <div class="widget-body no-padding">
                      <table id="example" class="display projects-table table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            <th></th>                                  
                            <th><i class="fa fa-fw fa-trophy text-muted hidden-md hidden-sm hidden-xs"></i><?php echo ObtenEtiqueta(2275); ?></th>
							<th><i class="fa fa-fw fa-calendar text-muted hidden-md hidden-sm hidden-xs"></i><?php echo ObtenEtiqueta(2276); ?></th> 
                            <th><i class="fa fa-fw fa-qrcode text-muted hidden-md hidden-sm hidden-xs"></i><?php echo ObtenEtiqueta(2277); ?></th>
							<th><i class="fa fa-fw fa-list text-muted hidden-md hidden-sm hidden-xs"></i></i><?php echo ObtenEtiqueta(2278); ?></th>
                            <th><i class="fa fa-fw fa-percent text-muted hidden-md hidden-sm hidden-xs">%</i> <?php echo ObtenEtiqueta(2279); ?></th>                                  
                            <th><i class="fa fa-fw fa-flag-checkered text-muted hidden-md hidden-sm hidden-xs"></i> <?php echo ObtenEtiqueta(2280); ?></th>                                                              
                            <th></th>                                                              
                          </tr>
                        </thead>
                      </table>
...
<div style="width: 228px; right: 0px; display: block; padding:0px 50px 10px 0px;" outline="0" class="ui-widget ui-chatbox">
	<a href="javascript:Envia('cupones_frm.php', '');" class="btn btn-primary btn-circle btn-xl" title="Add record" style="color:#FFFFFF;"><i class="fa fa-plus"></i></a>
</div>
