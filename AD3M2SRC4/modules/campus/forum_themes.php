<?php
  ...
  $Query  = "SELECT fl_tema, nb_tema '".ObtenEtiqueta(18)."', no_orden '".ETQ_ORDEN."|right', no_posts '".ObtenEtiqueta(560)."|right' ";
  $Query .= "FROM c_f_tema ";
  if(!empty($criterio)) {
    switch($actual) {
  ...
  PresentaPaginaListado(84, $Query, TB_LN_IUD, True, False, $opc);
