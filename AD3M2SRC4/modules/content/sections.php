<?php
  ...
  $Query .= "ds_menu '".ObtenEtiqueta(165)."|center', no_orden '".ETQ_ORDEN."|right' ";
  $Query .= "FROM ( ";
  $Query .= "SELECT fl_funcion, nb_funcion, tr_funcion, ds_funcion, nb_modulo, tr_modulo, nb_tipo_contenido, a.no_orden, ";
  ...
  $Query .= "AND (b.fg_admon IS NULL OR b.fg_admon='0') ";
  $Query .= "ORDER BY a.fl_modulo, b.no_orden, a.no_orden) AS principal ";
  if(!empty($criterio)) {
    switch($actual) {
