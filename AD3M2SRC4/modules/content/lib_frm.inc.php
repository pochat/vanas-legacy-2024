<?php
  ...
  if(!empty($clave)) {
    ...
    Forma_CampoLOV(ObtenEtiqueta(154), True, 'fl_funcion', $fl_funcion, 'nb_funcion', $nb_funcion, 35, 
      LOV_SECCIONES, LOV_TIPO_RADIO, LOV_ENORME, 'tipo_contenido', $nb_funcion_err, False, '', 'form-group smart-form', 'right', 'col-sm-4', 'col-sm-4');
      
    Forma_Espacio();
    Forma_CampoLOV(ObtenEtiqueta(153), True, 'cl_template', $cl_template, 'nb_template', $nb_template, 35, 
      LOV_TEMPLATES, LOV_TIPO_RADIO, LOV_MEDIANO, 'fl_funcion', $nb_template_err, False, '', 'form-group smart-form', 'right', 'col-sm-4', 'col-sm-4');
  }
  Forma_Espacio();
  Forma_CampoTexto(ObtenEtiqueta(190).' '.ETQ_FMT_FECHA, False, 'fe_ini', $fe_ini, 10, 10, $fe_ini_err, False, '', True, '', '', "form-group", 'right', 'col col-sm-4', 'col col-sm-4');
  Forma_Calendario('fe_ini');
  Forma_Espacio();
  Forma_CampoTexto(ObtenEtiqueta(192).' '.ETQ_FMT_FECHA, False, 'fe_fin', $fe_fin, 10, 10, $fe_fin_err, False, '', True, '', '', "form-group", 'right', 'col col-sm-4', 'col col-sm-4');
  ...
  if(!empty($clave)) {
    if($cl_tipo_contenido == TC_LIGA) {
      ...
      Forma_Espacio( );
      Forma_CampoTexto(ObtenEtiqueta(225), False, 'ds_ruta', $ds_ruta, 255, 0);
      Forma_CampoTexto(ObtenEtiqueta(245), False, 'tr_ruta', $tr_ruta, 255, 0);
      Forma_CampoLOV(ObtenEtiqueta(188), False, 'cl_pagina', $cl_pagina, 'nb_pagina', !empty($nb_pagina)?$nb_pagina:NULL, 35, 
        LOV_PAGINAS, LOV_TIPO_RADIO, LOV_GRANDE, '', '', True, '', 'form-group smart-form', 'right', 'col-sm-4', 'col-sm-4');
        Forma_Espacio();
      Forma_CampoLOV(ObtenEtiqueta(224), False, 'fl_seccion', $fl_seccion, 'nb_seccion', !empty($nb_seccion)?$nb_seccion:NULL, 35, 
        LOV_SECCIONES, LOV_TIPO_RADIO, LOV_ENORME, '', '', True, '', 'form-group smart-form', 'right', 'col-sm-4', 'col-sm-4');
