<?php
  ...
  if(!ValidaPermiso(FUNC_CICLOS, PERMISO_EJECUCION)) {
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_CICLOS; ?>">	                      
                  </div>
                  <!-- end widget edit box -->                  
                  <!-- widget content -->
...
<div style="width: 228px; right: 0px; display: block; padding:0px 50px 10px 0px;" outline="0" class="ui-widget ui-chatbox">
          <a href="javascript:Envia('cycles_frm.php', '');" class="btn btn-primary btn-circle btn-xl" title="Add record" style="color:#FFFFFF;"><i class="fa fa-plus"></i></a>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      function busqueda(instituto,programa){
        ...
        $.ajax({
            type: 'POST',
            url: 'div_dialogo_busqueda_cycles.php',
            async: false,
