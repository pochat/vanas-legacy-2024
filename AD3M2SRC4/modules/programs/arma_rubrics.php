...
$(document).ready(function() {
  ...
  if($accion == 0){
    # Inserta registro
    EjecutaQuery("INSERT INTO k_criterio_programa (fl_criterio, fl_programa, no_valor) VALUES ($fl_criterio_i, $clave, NULL)");
  }else{  
    # Inserta registro
    EjecutaQuery("DELETE FROM k_criterio_programa WHERE fl_criterio = $accion AND fl_programa = $clave");
  }
