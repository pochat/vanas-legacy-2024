<?php
  ...
  if(!ValidaPermiso(FUNC_CLASS_TIMES, PERMISO_EJECUCION)) {
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_CLASS_TIMES; ?>">	                      
                  </div>
                  <!-- end widget edit box -->                  
                  <!-- widget content -->
                          ...
                          <thead>
                              <tr>
                                 <th></th>
                                  ...
                                  <th><?php echo ObtenEtiqueta(370); ?></th>
                                  <th><?php echo ObtenEtiqueta(371); ?></th>
                                  <th><?php echo ObtenEtiqueta(373)."(s)"; ?></th>
                                  <th><?php echo ObtenEtiqueta(372); ?></th>
								  <th></th>
                              </tr>
                          </thead>                          
                      </table>
...
<!-- este programa no e puede insertar solo actualizar
<div style="width: 228px; right: 0px; display: block; padding:0px 50px 10px 0px;" outline="0" class="ui-widget ui-chatbox">
          <a href="javascript:Envia('class_time_frm.php', '');" class="btn btn-primary btn-circle btn-xl" title="Add record" style="color:#FFFFFF;"><i class="fa fa-plus"></i></a>
        </div>-->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      function busqueda(instituto,programa){
        ...
        $.ajax({
            type: 'POST',
            url: 'div_dialogo_busqueda_class_time.php',
            async: false,
      ...
      busqueda(4,0);
        ...
        return '<table cellpadding="5" cellspacing="0" border="0" class="table table-hover table-condensed" width="100%">'+
            '<tr>'+
                '<td width="30%">'+d.class_time+'</td>'+
                '<td>'+d.class_time_combined+' </td>'+
				'<td> </td>'+
				'<td> </td>'+
				'<td> </td>'+
            '</tr>'+
