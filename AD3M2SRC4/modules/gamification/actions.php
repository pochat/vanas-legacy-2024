<?php
  ...
  if(!ValidaPermiso(FUNC_ACTIONES, PERMISO_EJECUCION)) {
                  ...
                  <div class="widget-body no-padding">
                      <table id="example" class="display projects-table table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            <th></th>                                  
                            <th><i class=" text-muted hidden-md hidden-sm hidden-xs"></i>Action</th>
							<th><i class=" text-muted hidden-md hidden-sm hidden-xs"></i><?php echo ObtenEtiqueta(2164); ?></th> 
                            <th><i class=" text-muted hidden-md hidden-sm hidden-xs"></i><?php echo ObtenEtiqueta(2165); ?></th>
							<th><i class=" text-muted hidden-md hidden-sm hidden-xs"></i>Image</th>                                                            
                            <th></th>                                                              
                          </tr>
                        </thead>
                      </table>
...
<div style="width: 228px; right: 0px; display: block; padding:0px 50px 10px 0px;" outline="0" class="ui-widget ui-chatbox">
	<a href="javascript:Envia('actions_frm.php', '');" class="btn btn-primary btn-circle btn-xl" title="Add record" style="color:#FFFFFF;"><i class="fa fa-plus"></i></a>
</div>
