<?php
    ...
    */
     ...
     */
    $clave = RecibeParametroNumerico('user', True);
  ...
  $pdf = new MYPDF2('P', 'mm', 'LETTER', true, 'UTF-8', false);
  ...
  $nombre_archivo = '/AD3M2SRC4/modules/reports/GenerateArchives/merge/tempPDFs/transcript_'.$clave.'.pdf';
  
  //   set path 
  $path = $_SERVER['DOCUMENT_ROOT'].$nombre_archivo;
