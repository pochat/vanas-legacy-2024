...
$htmlcontent .= '<td style="width:15%; height:15px; color:#000000; font-family:Arial; font-size:35px;  text-align:center;"> ' . $porcentaje_final . ' %</td>';
...
$nombre_archivo = 'Transcript_quiz_' . $clave. '_' . $fl_usuario . '.pdf';
