<?php
  ...
  $fl_usuario = RecibeParametroNumerico('user', True);
  ...
  $ds_contrato = str_uso_normal(str_texto($row[1]));
  $ds_header = str_uso_normal(str_texto($row[2]));
  $ds_footer = str_uso_normal(str_texto($row[3]));
  ...
  if(!empty($ds_firma_alumno))
  {
    ...
    $ds_cuerpo=str_replace("&amp;nbsp;", "", $ds_cuerpo);
    $ds_cuerpo=str_replace("&amp;", "", $ds_cuerpo);
    $ds_cuerpo=str_replace("nbsp;", "", $ds_cuerpo);
    $ds_cuerpo=str_replace("&nbsp;", "", $ds_cuerpo);
  }
  else
  {
    $ds_encabezado = str_uso_normal(genera_documento($clave, 1, False, False, $no_contrato));
    $ds_cuerpo = str_uso_normal(genera_documento($clave, 2, False, False, $no_contrato));
    $ds_pie = str_uso_normal(genera_documento($clave, 3, False, False, $no_contrato));
  }

  $nb_template = str_uso_normal(genera_documento($clave, 4, False, False, $no_contrato));
  ...
  class MYPDF extends TCPDF
  {
    ...
    public function Footer()
    {
      ...
      $ds_pie=str_replace("&amp;nbsp;", "", $ds_pie);
      $ds_pie=str_replace("&amp;", "", $ds_pie);
      $ds_pie=str_replace("nbsp;", "", $ds_pie);
      $ds_pie=str_replace("&nbsp;", "", $ds_pie);
  ...
  $nombre_archivo = 'contract_'.$clave.'_'.$no_contrato.'_'.$fl_usuario.'.pdf';
