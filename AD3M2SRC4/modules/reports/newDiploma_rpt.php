 ...
 */
  ...
  /**
   * FLATTEN
   * The flatten PDF properties
   * are not available for the TCPDF library
   * so, I look that the SetProtection function
   * has a property to block to open the file
   * with another software to modify the contents
   * for example, Adove Ilustrator.
   * this function asks for a password and blocks the file
   */
  // Set owner password
 ...
 //   $pdf->SetXY(29, 195);
  ...
  //Output file name
  $nombre_archivo = $ds_nombres.' '.$ds_apaterno.' VANAS Diploma '.$fe_graduate.'.pdf';
