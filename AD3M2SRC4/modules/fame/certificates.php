<?php
  ...
  if(!ValidaPermiso(FUNC_CERTIFICADO_FAME, PERMISO_EJECUCION)) {
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_CERTIFICADO_FAME; ?>">	
                  </div>
                  <!-- end widget edit box -->
                              ...
                              <tr>
                                 <th></th>
                                  ...
                                  <th><?php echo ObtenEtiqueta(1565); ?></th>
                                   <th><?php echo ObtenEtiqueta(1566); ?></th>
                                 
                                  <th><?php echo ObtenEtiqueta(1568); ?></th>

                                  <th><?php echo ObtenEtiqueta(1569); ?></th>
                                  <th><?php echo ObtenEtiqueta(1570); ?></th>
                                  <th><?php echo ObtenEtiqueta(1571); ?></th>
                                   <th><?php echo ObtenEtiqueta(1572); ?></th>


                                 
                                  <th><?php echo ObtenEtiqueta(1545); ?></th>
                              </tr>
                          </thead>                          
                      </table>
                  </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        return '<table cellpadding="5" cellspacing="0" border="0" class="table table-hover table-condensed" width="100%">'+
            '<tr>'+
                '<td>'+
                'Archives Send: '+ d.link +
                '<span class="pull-right" style="margin-right: 5%;"> Password: '+ d.link_password +' </span>' +
                '</td>'+
            '</tr>'+
        '</table>';
        }
