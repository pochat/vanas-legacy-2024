...
<form action="students.php" method='POST' name='frm_search_fame' id='frm_search_fame' class='smart-form'>
  <div class="col-sm-12 col-md-12 col-lg-4">
    ...
    $Query .= "WHERE exists(SELECT 1 FROM c_usuario u WHERE u.fl_instituto=i.fl_instituto AND u.fl_perfil_sp=".PFL_ESTUDIANTE_SELF.") ORDER BY i.ds_instituto;";
  ...
  <div class="col-sm-12 col-md-12 col-lg-4">
    ...
    $Query .= "LEFT JOIN k_usuario_programa b ON (b.fl_usuario_sp=a.fl_usuario) ";
    $Query .= "LEFT JOIN c_programa_sp c ON (c.fl_programa_sp=b.fl_programa_sp) ";
    $Query .= "WHERE fl_instituto=".$instituto." AND fl_perfil_sp=".PFL_ESTUDIANTE_SELF." GROUP BY b.fl_programa_sp ";
     $rs = EjecutaQuery($Query);
     for($i=0;$row=RecuperaRegistro($rs); $i++){
       ...
       $Queryy .= "WHERE a.fl_programa_sp=".$fl_programa_sp."  AND fl_instituto=".$instituto." AND fl_perfil_sp=".PFL_ESTUDIANTE_SELF;
