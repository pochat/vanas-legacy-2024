...
<div class="tab-pane fade" id="quiz">
  ...
  <div id="tabs2" style="display:none;">
    <?php
      ...
      if(empty($clave)){
        ...
        echo "document.getElementById('ds_course_1').value = res_tot;
      ...
      $row_a = RecuperaValor("SELECT SUM(ds_valor_pregunta) FROM k_quiz_pregunta WHERE fl_leccion_sp = $clave");
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-3">
        <?php Forma_CampoTexto(ObtenEtiqueta(1253), False, 'nb_quiz', $nb_quiz, 100, 30); ?>
      </div>
      <div class="col-sm-1">
      </div>
      <?php 
      ...
      ?>
      <div class="col-xs-12 col-sm-3">
        <div id="div_no_semana2" class="row form-group" <?php echo popover('','',$warning, ObtenEtiqueta(1284));  ?>>
          <label class="col-sm-8 control-label text-align-right">
      ...
      <div class="col-xs-12 col-sm-3">
        <?php
          $c_remaining=!empty($c_remaining)?$c_remaining:NULL;
          Forma_CampoOculto('c_remaining', !empty($c_remaining)?$c_remaining:'');
          Forma_CampoTexto(ObtenEtiqueta(1214), False,'ds_course_1', ($valor_inicial??NULL), 3, 3, !empty($ds_course_1_err)?$ds_course_1_err:'', False, '', True, 'disabled', '', "form-group", 'right', 'col col-sm-8', 'col col-sm-3');
          if($c_remaining != 0){
            echo "<script>
    ...
    <input type="hidden" id="CuantosLi" name="CuantosLi" value="<?php echo ($tot_preguntas??NULL); ?>">
    <ul id="tabss">
      <li> 
        <a id="add_tab" ><i class="fa fa-lg fa-plus-circle"></i></a>
      </li>
      ...
      <div class="row">
        ...
        <div class="col col-xs-6 col-sm-4">
          <?php                   
            ...
            echo "<label>";
            CampoRadio('fg_tipo_resp_1', 'T', $fg_tipo_resp_1, ObtenEtiqueta(1202), True, 'onchange="showContent(this.value); Valida_Quiz();"');
            echo "</label>";
            echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
            echo "<label>";
            CampoRadio('fg_tipo_resp_1', 'I', $fg_tipo_resp_1, ObtenEtiqueta(1203), True, 'onchange="showContent(this.value); Valida_Quiz();"');
            echo "</label>";
            echo "</div>";
            echo "</div>";
        ...
        <div id="img_based_1" <?php echo $style_1; ?>>
          <div class="col col-xs-6 col-sm-6">
            <?php                           
              ...
              echo "<div class='radio'>";
              echo "<label>";                            
              CampoRadio('fg_tipo_img_1', 'L', $fg_tipo_img_1, ObtenEtiqueta(1211), True, "onchange='TipoImagen(this.value);'");
              echo "</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>";
              CampoRadio('fg_tipo_img_1', 'P', $fg_tipo_img_1, ObtenEtiqueta(1212), True, "onchange='TipoImagen(this.value);'");
              echo "</label>";
              echo "</div>";
              echo "</div>";
          ...
          <div id="myTabQC" class="tab-content padding-10 no-border">
            <div class="tab-pane fade in active" id="tab-quiz_eng">
              ...
              <div class="row">
                <div class="col col-xs-12 col-sm-5">
                  <?php
                    Forma_CampoTexto(ObtenEtiqueta(1200).' 1', False, 'ds_pregunta_1', ($ds_pregunta_1??NULL), 255,60, ($ds_pregunta_1_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                  ?>
                </div>  
                    ...
                    <div class="col-sm-12"> 
                      <div class="smart-form">  
                        <label class="input" id="error_msj3_1">
                          <input class="form-control" id="valor_1" name="valor_1" value="<?php echo $ds_quiz_1; ?>" maxlength="3" size="10" type="text" onkeyup="Suma_val_preg_quiz(this.value); Suma_val_resp_quiz(this.value, 'valor_1'); Valida_Quiz(); $('#muestra_valor_1').removeAttr('padding-left').css('padding-left', '20%');" onKeyPress="return SoloNumeros(event);">
                        </label>
                        <?php
                ...
                <div class="col col-xs-12 col-sm-2">
                  <?php                    
                    Forma_CampoOculto('q_remaining_1', !empty($q_remaining_1)?$q_remaining_1:NULL);
                    Forma_CampoTexto(ObtenEtiqueta(1213),False,'ds_quiz_1',$valor_ini_preg,3,10,!empty($ds_quiz_1_err)?$ds_quiz_1_err:NULL, False, '', True, 'disabled', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    // if(empty($fg_error)){
                      if(isset($q_remaining_1)){
                        echo "<script>
              ...
              <div id="img_based_2" <?php echo $style_2; ?>> 
                <div class="row">
                  <div class="col col-xs-12 col-sm-3">
                    <?php
                      Forma_CampoTexto(ObtenEtiqueta(1204).' 1',False,'ds_resp_1', ($ds_resp_1??NULL),255,41, ($ds_resp_1_err??NULL), False, '', True, '', '', "from-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>
                  <div class="col col-xs-12 col-sm-1">
                  </div>
                  <div class="col col-xs-12 col-sm-2">
                    <?php
                      ...
                      Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_1', ($ds_grade_1??NULL),3,10, ($ds_grade_1_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_1\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>
                  <div class="col col-xs-12 col-sm-3">
                    <?php
                      Forma_CampoTexto(ObtenEtiqueta(1204).' 2',False,'ds_resp_2', ($ds_resp_2??NULL),255,41, ($ds_resp_2_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>
                  <div class="col col-xs-12 col-sm-1">
                  </div>
                  <div class="col col-xs-12 col-sm-2">
                    <?php
                      Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_2', ($ds_grade_2??NULL),3,10, ($ds_grade_2_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_2\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>
                </div>
                <div class="row">           
                  <div class="col col-xs-12 col-sm-3">
                    <?php
                      Forma_CampoTexto(ObtenEtiqueta(1204).' 3',False,'ds_resp_3', ($ds_resp_3??NULL),255,41, ($ds_resp_3_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>
                  <div class="col col-xs-12 col-sm-1">
                  </div>
                  <div class="col col-xs-12 col-sm-2">
                    <?php
                      Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_3', ($ds_grade_3??NULL),3,10, ($ds_grade_3_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_3\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>
                  <div class="col col-xs-12 col-sm-3">
                    <?php
                      Forma_CampoTexto(ObtenEtiqueta(1204).' 4',False,'ds_resp_4', ($ds_resp_4??NULL),255,41, ($ds_resp_4_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>
                  <div class="col col-xs-12 col-sm-1">
                  </div>
                  <div class="col col-xs-12 col-sm-2">
                    <?php
                      Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_4', ($ds_grade_4??NULL),3,10, ($ds_grade_4_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_4\');Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>
                </div>
              </div>
            ...
            <!-- END English Content-->
              <div class="tab-pane fade in " id="tab-quiz_esp">
                ...
                <div class="row">
                  <div class="col col-xs-12 col-sm-5">
                    <?php
                      Forma_CampoTexto(ObtenEtiqueta(1200).' 1',False,'ds_pregunta_esp_1', ($ds_pregunta_esp_1??NULL),255,60, ($ds_pregunta_1_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>  
                  <div class="col col-xs-12 col-sm-1">
                  </div> 
                  ...
                  <div class="col col-xs-12 col-sm-2">
                    <?php                    
                      Forma_CampoOculto('q_remaining_1', ($q_remaining_1??NULL));
                      Forma_CampoTexto(ObtenEtiqueta(1213),False,'ds_quiz_1_esp',$valor_ini_preg,3,10, ($ds_quiz_1_err??NULL), False, '', True, 'disabled', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      // if(empty($fg_error)){
                        if(isset($q_remaining_1)){
                          echo "<script>
                            document.getElementById('ds_quiz_1').value = document.getElementById('q_remaining_1').value;
                ...
                <div id="img_based_2_esp" <?php echo $style_2; ?>> 
                  <div class="row">
                    <div class="col col-xs-12 col-sm-3">
                      <?php
                        Forma_CampoTexto(ObtenEtiqueta(1204).' 1',False,'ds_resp_esp_1', ($ds_resp_esp_1??NULL),255,41, ($ds_resp_1_err??NULL), False, '', True, '', '', "from-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                    <div class="col col-xs-12 col-sm-1">
                    </div>
                    <div class="col col-xs-12 col-sm-2">
                      <?php
                        $var = "<a href='javascript:void(0);' class='' rel='tooltip' data-placement='top' data-original-title='".ObtenEtiqueta(1283)."' tabindex='100000'><i class='fa fa-info-circle'></i></a>&nbsp;&nbsp;&nbsp;";
                        Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_1esp', ($ds_grade_1??NULL),3,10, ($ds_grade_1_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_1\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                    <div class="col col-xs-12 col-sm-3">
                      <?php
                        Forma_CampoTexto(ObtenEtiqueta(1204).' 2',False,'ds_resp_esp_2', ($ds_resp_esp_2??NULL),255,41, ($ds_resp_2_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                    <div class="col col-xs-12 col-sm-1">
                    </div>
                    <div class="col col-xs-12 col-sm-2">
                      <?php
                        Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_2esp', ($ds_grade_2??NULL),3,10, ($ds_grade_2_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_2\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                  </div>
                  <div class="row">           
                    <div class="col col-xs-12 col-sm-3">
                      <?php
                        Forma_CampoTexto(ObtenEtiqueta(1204).' 3',False,'ds_resp_esp_3', ($ds_resp_esp_3??NULL),255,41, ($ds_resp_3_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                    <div class="col col-xs-12 col-sm-1">
                    </div>
                    <div class="col col-xs-12 col-sm-2">
                      <?php
                        Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_3esp', ($ds_grade_3??NULL),3,10, ($ds_grade_3_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_3\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                    <div class="col col-xs-12 col-sm-3">
                      <?php
                        Forma_CampoTexto(ObtenEtiqueta(1204).' 4',False,'ds_resp_esp_4', ($ds_resp_esp_4??NULL),255,41, ($ds_resp_4_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                    <div class="col col-xs-12 col-sm-1">
                    </div>
                    <div class="col col-xs-12 col-sm-2">
                      <?php
                        Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_4esp', ($ds_grade_4??NULL),3,10, ($ds_grade_4_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_4\');Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                  </div>
                </div>
              ...
              <div class="tab-pane fade in " id="tab-quiz_fra">
                ...
                <div class="row">
                  <div class="col col-xs-12 col-sm-5">
                    <?php
                      Forma_CampoTexto(ObtenEtiqueta(1200).' 1',False,'ds_pregunta_fra_1', ($ds_pregunta_fra_1??NULL),255,60, ($ds_pregunta_1_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                    ?>
                  </div>  
                  <div class="col col-xs-12 col-sm-1">
                  </div> 
                ...
                <div id="img_based_2_fra" <?php echo $style_2; ?>> 
                  <div class="row">
                    <div class="col col-xs-12 col-sm-3">
                      <?php Forma_CampoTexto(ObtenEtiqueta(1204).' 1',False,'ds_resp_fra_1', ($ds_resp_fra_1??NULL),255,41, ($ds_resp_1_err??NULL), False, '', True, '', '', "from-group", 'left', 'col col-sm-12', 'col col-sm-12'); ?>
                    </div>
                    <div class="col col-xs-12 col-sm-1">
                    </div>
                    <div class="col col-xs-12 col-sm-2">
                      <?php
                        $var = "<a href='javascript:void(0);' class='' rel='tooltip' data-placement='top' data-original-title='".ObtenEtiqueta(1283)."' tabindex='100000'><i class='fa fa-info-circle'></i></a>&nbsp;&nbsp;&nbsp;";
                        Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_1fra', ($ds_grade_1??NULL),3,10, ($ds_grade_1_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_1\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                      ?>
                    </div>
                    <div class="col col-xs-12 col-sm-3">
                      <?php Forma_CampoTexto(ObtenEtiqueta(1204).' 2',False,'ds_resp_fra_2', ($ds_resp_fra_2??NULL),255,41, ($ds_resp_2_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); ?>
                    </div>
                    <div class="col col-xs-12 col-sm-1">
                    </div>
                    <div class="col col-xs-12 col-sm-2">
                      <?php Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_2fra', ($ds_grade_2??NULL),3,10, ($ds_grade_2_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_2\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); ?>
                    </div>
                  </div>
                  <div class="row">           
                    <div class="col col-xs-12 col-sm-3">
                      <?php Forma_CampoTexto(ObtenEtiqueta(1204).' 3',False,'ds_resp_fra_3', ($ds_resp_fra_3??NULL),255,41, ($ds_resp_3_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); ?>
                    </div>
                    <div class="col col-xs-12 col-sm-1">
                    </div>
                    <div class="col col-xs-12 col-sm-2">
                      <?php Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_3fra', ($ds_grade_3??NULL),3,10, ($ds_grade_3_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_3\'); Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); ?>
                    </div>
                    <div class="col col-xs-12 col-sm-3">
                      <?php Forma_CampoTexto(ObtenEtiqueta(1204).' 4',False,'ds_resp_fra_4', ($ds_resp_fra_4??NULL),255,41, ($ds_resp_4_err??NULL), False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); ?>
                    </div>
                    <div class="col col-xs-12 col-sm-1">
                    </div>
                    <div class="col col-xs-12 col-sm-2">
                      <?php Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_4fra', ($ds_grade_4??NULL),3,10, ($ds_grade_4_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_4\');Valida_Quiz();" onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); ?>
                    </div>
                  </div>
                </div>
                <!------------END OF ANSWERS-------------->
            ...
            <div id="img_based_3" <?php echo $style_3; ?>> 
              ...
              <div class="row">
                <div class="col col-xs-12 col-sm-4">
                  <?php                      
                    CargaImagenDropZone(ObtenEtiqueta(1204).' 1', 'mydropzone_1', '1', $editar, ($fl_quiz_pregunta??NULL), $fg_error, ($nb_img_prev_mydropzone_1_1??NULL), "L", "Valida_Quiz();", $fg_tipo_resp_1);
                  ?>
                </div>
                <div class="col col-xs-12 col-sm-2">
                  <?php
                    $var = "<a href='javascript:void(0);' class='' rel='tooltip' data-placement='top' data-original-title='".ObtenEtiqueta(1283)."'><i class='fa fa-info-circle'></i></a>&nbsp;&nbsp;&nbsp;";
                    Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_img_1', ($ds_grade_img_1??NULL),3,10, ($ds_a_email_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_img_1\'); Valida_Quiz();"  onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                  ?>
                </div>
                <div class="col col-xs-12 col-sm-4">
                  <?php CargaImagenDropZone(ObtenEtiqueta(1204).' 2', 'mydropzone_2', '1', $editar, ($fl_quiz_pregunta??NULL), $fg_error, ($nb_img_prev_mydropzone_2_1??NULL), "L", "Valida_Quiz();", $fg_tipo_resp_1); ?>
                </div>
                <div class="col col-xs-12 col-sm-2">
                  <?php
                    Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_img_2',($ds_grade_img_2??NULL),3,10, ($ds_a_email_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_img_2\'); Valida_Quiz();"  onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                  ?>
                </div>
              </div>
              <div class="row">             
                <div class="col col-xs-12 col-sm-4">
                  <?php
                    CargaImagenDropZone(ObtenEtiqueta(1204).' 3', 'mydropzone_3', '1', $editar, ($fl_quiz_pregunta??NULL), $fg_error, ($nb_img_prev_mydropzone_3_1??NULL), "L", "Valida_Quiz();", $fg_tipo_resp_1);
                  ?>   
                </div>
                <div class="col col-xs-12 col-sm-2">
                  <?php
                    Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_img_3', ($ds_grade_img_3??NULL),3,10, ($ds_a_email_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_img_3\'); Valida_Quiz();"  onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                  ?>
                </div>
                <div class="col col-xs-12 col-sm-4">
                  <?php
                    CargaImagenDropZone(ObtenEtiqueta(1204).' 4', 'mydropzone_4', '1', $editar, ($fl_quiz_pregunta??NULL), $fg_error, ($nb_img_prev_mydropzone_4_1??NULL), "L", "Valida_Quiz();", $fg_tipo_resp_1);
                  ?>   
                </div>
                <div class="col col-xs-12 col-sm-2">
                  <?php
                    Forma_CampoTexto($var.ObtenEtiqueta(1205),False,'ds_grade_img_4', ($ds_grade_img_4??NULL),3,10, ($ds_a_email_err??NULL), False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_img_4\'); Valida_Quiz();"  onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
                  ?>
                </div>
              </div>
            </div>
            ...
            <script>
              function MuestraPreview_<?php echo 1; ?>(tabCounter){
                ...
                if(tipo == 'I'){
                  for(inc=1; inc<=4; inc++){
                    document.getElementById('Img_' + inc + '_1').src = '<?php echo PATH_MODULOS; ?>/fame/uploads/' + document.getElementById('nb_img_prev_mydropzone_' + inc).value;
                    document.getElementById('Img2_' + inc + '_1').src = '<?php echo PATH_MODULOS; ?>/fame/uploads/' + document.getElementById('nb_img_prev_mydropzone_' + inc).value;
                  }
                }
                // Abrimos modal
  ...
  <input type='hidden' name='tabs_add' id='tabs_add' value='1' />
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      function addTab() {
        ...
        $.ajax({
          data:  parametros,
          url:   'lmedia_ajax.php?nuevo=True',
          type:  'post',
