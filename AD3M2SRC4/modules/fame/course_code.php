<?php
  ...
  if(!ValidaPermiso(FUNC_COURSESCODE, PERMISO_EJECUCION)) {
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_COURSESCODE; ?>">	
                  </div>
                  <!-- end widget edit box -->
                          ...
                          <thead>
                              <tr>
                                 <th></th>
                                  ...
                                  <th><?php echo ObtenEtiqueta(2050); ?></th>
                                  <th><?php echo ObtenEtiqueta(2052); ?></th>
                                  <th><?php echo ObtenEtiqueta(2053); ?></th>
								   <th>Country</th>
                                  <th><?php echo ObtenEtiqueta(2054); ?></th>
                                  <th><?php echo ObtenEtiqueta(2055); ?></th>
                                  <th>&nbsp;</th>
                              </tr>
                          </thead>                          
                      </table>
