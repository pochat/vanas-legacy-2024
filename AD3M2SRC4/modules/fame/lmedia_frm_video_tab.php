<div class="tab-pane fade" id="video">
    <div class="row">
        ...
        <?php
        $p_titulo= !empty($p_titulo)?$p_titulo:NULL;
        # si ocuparon algun video de otra leccion
        if(!empty($ds_vl_ruta)){
            ...
            Forma_CampoPreview(ObtenEtiqueta(392), 'ds_vl_ruta', $cla, !empty($ruta)?$ruta:NULL, True);
            echo "
            <script>
    ...
    <div class='col col-sm-12 col-lg-6 col-md-12'>
        ...
        <label>
        <?php
            CampoCheckbox('fg_reset_video', !empty($fg_reset_video)?$fg_reset_video:NULL, 'Re-start video encoding', '', True);
        ?>
        </label>
        </div>
    </div>
    ...
    <?php
        Forma_CampoOculto('total_convertido', !empty($total_convertido)?$total_convertido:NULL);
        }
    ?>
    <div class="row">
        <style>      
    ...
    <div class="row">
        ...
        <?php
            ...
            Forma_CampoSelectBD(ObtenEtiqueta(389), False, 'archivo_a', $Query, ($archivo_a??NULL), '', True, '', 'right', 'col col-md-4', 'col col-md-8');
            Forma_Espacio();
        ?>
        </div>
    </div>
    <div class="row">
        ...
        <?php
            Forma_CampoTexto(ObtenEtiqueta(396), False, 'ds_vl_duracion', $ds_vl_duracion, 10, 12);
        ?>
        </div>
