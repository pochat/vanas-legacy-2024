<?php
  ...
  if(!ValidaPermiso(FUNC_LICENCES, PERMISO_EJECUCION)) {
    MuestraPaginaError(ERR_SIN_PERMISO);
    exit;
  }
  
  PresentaHeader();
  PresentaEncabezado(FUNC_LICENCES);//fl_de_funcion
      ...
      <div class="col-xs-12 col-sm-12" style="padding: 3px">
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              <header role="heading">
                  ...
                  <h2> License Pricing Information  </h2>
...
<div style="width: 228px; right: 0px; display: block; padding:0px 50px 10px 0px;" outline="0" class="ui-widget ui-chatbox">
          <a href="javascript:Envia('pricing_frm.php', '');" class="btn btn-primary btn-circle btn-xl" title="Add record" style="color:#FFFFFF;"><i class="fa fa-plus"></i></a>
        </div>-->
          ...
          "columns": [
             ...
             // { "data": "checkbox", "orderable": false },
			  ...
			  { "data": "status","class": 'text-align-center'  },
			   { "data": "princing_default","class": 'text-align-center'  },
              { "data": "action" },
