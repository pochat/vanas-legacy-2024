<?php
  ...
  $Query .= "JOIN c_usuario U ON I.fl_instituto=U.fl_instituto
             ...
             WHERE I.fl_instituto=$fl_instituto and I.fg_tiene_plan='1' AND fl_perfil_sp <> ".PFL_ADMINISTRADOR." AND fl_perfil_sp <> ".PFL_ADM_CSF." ";
  $Query .= ")UNION(
			 ...
			 JOIN k_responsable_alumno B ON B.fl_envio_correo=A.fl_envio_correo
...
?>
{
    ...
    for($i=1;$row=RecuperaRegistro($rs);$i++) {
		...
		$fg_autorizado=$row['fg_autorizado'];
		$fg_confirmado=$row['confirmar'];
