<?php
  ...
  if(!ValidaPermiso(FUNC_PARTNER_SCHOOL, PERMISO_EJECUCION)) {
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_PARTNER_SCHOOL; ?>">	
                  </div>
                  <!-- end widget edit box -->
                          ...
                          <thead>
                              <tr>
                                 <th></th>
                                  ...
                                  <th><?php echo ObtenEtiqueta(1580); ?></th>
    ...
    $(document).ready(function () {
      ...
      var table = $('#example').on('processing.dt', function (e, settings, processing) {
          ...
          "columns": [
              ...
              { "data": "name_school" },
              { "data": "course" },
              { "data": "age","class": 'text-align-left' },
