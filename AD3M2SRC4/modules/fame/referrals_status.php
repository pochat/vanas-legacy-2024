<?php
  ...
  if(!ValidaPermiso(FUNC_REFERRAL_STATUS, PERMISO_EJECUCION)) {
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_REFERRAL_STATUS; ?>">	
                  </div>
                  <!-- end widget edit box -->
                      ...
                      <table id="example" class="display projects-table table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                          <thead>
                              <tr>
                                 ...
                                 <th><?php echo ObtenEtiqueta(2111); ?></th>
                                  <th><?php echo ObtenEtiqueta(2203); ?></th>
                                  <th><?php echo ObtenEtiqueta(2204); ?></th>
                                  <th><?php echo ObtenEtiqueta(2205); ?></th>
                                  <th>Country </th>
								   <th><?php echo ObtenEtiqueta(2206); ?></th>
...
<div style="width: 228px; right: 0px; display: block; padding:0px 50px 10px 0px;" outline="0" class="ui-widget ui-chatbox">
          <a href="javascript:Envia('course_code_frm.php', '');" class="btn btn-primary btn-circle btn-xl" title="Add record" style="color:#FFFFFF;"><i class="fa fa-plus"></i></a>
        </div>-->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      var table = $('#example').on('processing.dt', function (e, settings, processing) {
          ...
          "ajax": "referrals_status_list.php",
          //"serverSide": true,
          "processing": true,
          "bDestroy": true,
          "order": [[ 6, "desc" ]],
