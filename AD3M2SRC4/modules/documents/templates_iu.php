...
if ($fg_reset == 1) {
  ...
  $ds_cuerpo_esp = RecibeParametroHTML('ds_cuerpo_esp');
  $ds_cuerpo_fra = RecibeParametroHTML('ds_cuerpo_fra');
  ...
  if ($fg_error) {
    ...
    Forma_CampoOculto('ds_encabezado_esp', $ds_encabezado_esp);
    Forma_CampoOculto('ds_encabezado_fra', $ds_encabezado_fra);
    Forma_CampoOculto('ds_encabezado_de', $ds_encabezado_de);
    Forma_CampoOculto('ds_encabezado_it', $ds_encabezado_it);
    Forma_CampoOculto('ds_cuerpo', $ds_cuerpo);
    Forma_CampoOculto('ds_cuerpo_esp', $ds_cuerpo_esp);
    Forma_CampoOculto('ds_cuerpo_fra', $ds_cuerpo_fra);
    Forma_CampoOculto('ds_cuerpo_de', $ds_cuerpo_de);
    Forma_CampoOculto('ds_cuerpo_it', $ds_cuerpo_it);
...
<script>
  ...
  if (!empty($clave)) {
    ...
    $Query .= "SET nb_template='$nb_template', fl_categoria=$fl_categoria, fg_activo='$fg_activo', fg_sistema='$fg_sistema' , ";
    $Query .= "ds_encabezado='$ds_encabezado',ds_encabezado_it='$ds_encabezado_it',ds_encabezado_de='$ds_encabezado_de', ds_encabezado_esp='$ds_encabezado_esp', ds_encabezado_fra='$ds_encabezado_fra', ds_cuerpo='$ds_cuerpo', ds_cuerpo_esp='$ds_cuerpo_esp', ds_cuerpo_fra='$ds_cuerpo_fra',ds_cuerpo_it='$ds_cuerpo_it',ds_cuerpo_de='$ds_cuerpo_de', ds_pie='$ds_pie', fe_modificacion=NOW() ";
    if ($fg_factory == 1)
      $Query .= ",ds_encabezado_r='$ds_encabezado', ds_cuerpo_r='$ds_cuerpo', ds_pie_r='$ds_pie' ";
    $Query .= "WHERE fl_template=$clave";
  } else {
    $Query  = "INSERT INTO k_template_doc (nb_template, fl_categoria, fg_activo, ds_encabezado, ds_encabezado_esp, ds_encabezado_fra, ds_cuerpo, ds_cuerpo_esp, ds_cuerpo_fra, ds_pie, ";
    $Query .= "ds_encabezado_r, ds_cuerpo_r, ds_pie_r,ds_encabezado_de,ds_encabezado_it,ds_cuerpo_de,ds_cuerpo_it, fe_creacion, fe_modificacion) ";
    $Query .= "VALUES('$nb_template', $fl_categoria, '$fg_activo', '$ds_encabezado', '$ds_encabezado_esp', '$ds_encabezado_fra', '$ds_cuerpo', '$ds_cuerpo_esp', '$ds_cuerpo_fra','$ds_pie', ";
    $Query .= "'$ds_encabezado', '$ds_cuerpo', '$ds_pie','$ds_encabezado_de','$ds_encabezado_it','$ds_cuerpo_de','$ds_cuerpo_it', NOW(), NOW())";
  }
  EjecutaQuery($Query);
}
