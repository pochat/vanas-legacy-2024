<?php
  ...
  Forma_Espacio();
  Forma_CampoTexto(ObtenEtiqueta(120).' '.ETQ_FMT_FECHA, False, 'fe_nacimiento', $fe_nacimiento, 10, 10, $fe_nacimiento_err, False, '', True, '', '', "form-group", 'right', 'col col-sm-4', 'col col-sm-4');
  ...
  Forma_CampoLOV(ObtenEtiqueta(110), True, 'fl_perfil', $fl_perfil, 'nb_perfil', $nb_perfil, 30, 
    LOV_PERFILES, LOV_TIPO_RADIO, LOV_MEDIANO, '', $fl_perfil_err, False, '', 'form-group smart-form', 'right', 'col-sm-4', 'col-sm-4');
