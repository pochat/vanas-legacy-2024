<?php
  ...
  if($fg_error)
    Forma_PresentaError( );
  Forma_CampoTexto(ObtenEtiqueta(240), True, 'ds_area', $ds_area, 255, 0, $ds_area_err);
  Forma_CampoTexto(ETQ_TRADUCCION, False, 'tr_area', $tr_area, 255, 0);
  Forma_CampoTexto(ObtenEtiqueta(121), True, 'ds_email', $ds_email, 255, 0, $ds_email_err);
  ...
  Forma_CampoTexto(ObtenEtiqueta(241), False, 'ds_etq_anexo', $ds_etq_anexo, 255, 0, $ds_etq_anexo_err);
  Forma_CampoTexto(ETQ_TRADUCCION, False, 'tr_etq_anexo', $tr_etq_anexo, 255, 0);
  Forma_Espacio( );
