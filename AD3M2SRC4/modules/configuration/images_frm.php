<?php
  ...
  if(!empty($nb_archivo)) {
    ...
    switch($ext) {
	  ...
	  case "OGG": $ruta = SP_VIDEOS; break;
	  case "MP3": $ruta = SP_VIDEOS; break;
	  case "WAV": $ruta = SP_VIDEOS; break;
      default:    $ruta = SP_IMAGES_W; break;
    }
    
    if(  ($ext=="OGG") || ($ext=="MP3") || ($ext=="WAV") ) {
        echo "<a href='javascript:void(0);' data-toggle='modal' data-target='#myModal'> $nb_archivo</a> ";
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="myModal"><i class="fa fa-volume-up" aria-hidden="true"></i> <?php echo $nb_archivo; ?></h5>
		  ...
		  <div class="modal-body text-center">
			...
			<audio controls>
			  <source src="<?php echo "../../../images/".$nb_archivo ?>" type="audio/ogg">
			  <source src="<?php echo "../../../images/".$nb_archivo ?>" type="audio/mpeg">
			  <?php 
				if(!empty($tr_archivo)) {
			  ?>
			  
			  <source src="<?php echo "../../../images/".$tr_archivo ?>" type="audio/ogg">
			  <source src="<?php echo "../../../images/".$tr_archivo ?>" type="audio/mpeg">
