<?php
  ...
  Forma_Espacio( );
  Forma_CampoTexto(ETQ_TITULO, False, 'ds_titulo', $ds_titulo, 255, 0);
  Forma_CampoTexto(ETQ_TRADUCCION, False, 'tr_titulo', $tr_titulo, 255, 0);
  Forma_Espacio( );
  Forma_CampoTexto(ObtenEtiqueta(130), True, 'ds_mensaje', $ds_mensaje, 500, 0, $ds_mensaje_err);
  Forma_CampoTexto(ETQ_TRADUCCION, False, 'tr_mensaje', $tr_mensaje, 500, 0);
  Forma_Espacio( );
