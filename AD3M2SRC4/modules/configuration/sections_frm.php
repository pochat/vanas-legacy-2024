<?php
  ...
  if(!$fg_error) { // Sin error, viene del listado
    ...
    $tr_flash_default = RecibeParametroHTML('nb_flash_default');
  ...
  Forma_CampoLOV(ObtenEtiqueta(160), True, 'fl_menu', $fl_menu, 'nb_menu', $nb_menu, 35, 
      LOV_MENUS, LOV_TIPO_RADIO, LOV_GRANDE, '', $nb_menu_err);
  Forma_CampoLOV(ObtenEtiqueta(164), True, 'fl_modulo', $fl_modulo, 'nb_submenu', $nb_submenu, 35, 
      LOV_SUBMENUS, LOV_TIPO_RADIO, LOV_GRANDE, 'fl_menu', $nb_submenu_err);
  ...
  Forma_CampoSelectBD(ObtenEtiqueta(232), 'cl_tipo_contenido', $Query, $cl_tipo_contenido);
  ...
  Forma_CampoSelect(ObtenEtiqueta(180), 'fg_tipo_orden', $opc, $val, $fg_tipo_orden);
  Forma_Espacio( );
  if(!empty($nb_flash_default)) {
    Forma_CampoPreview(ObtenEtiqueta(184), 'nb_flash_default', $nb_flash_default, SP_FLASH);
  ...
  if(!empty($tr_flash_default)) {
    Forma_CampoPreview(ObtenEtiqueta(245), 'tr_flash_default', $tr_flash_default, SP_FLASH);
  ...
  Forma_CampoSelectBD(ObtenEtiqueta(140), 'fl_flujo', $Query, $fl_flujo);
  $opc = array(ObtenEtiqueta(177), ObtenEtiqueta(176));
  $val = array('X', 'R'); // X=Gratis, R=Restringido
  Forma_CampoSelect(ObtenEtiqueta(175), 'fg_tipo_seguridad', $opc, $val, $fg_tipo_seguridad);
