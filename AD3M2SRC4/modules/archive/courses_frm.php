<?php
  ...
  # Campos de captura
  Forma_CampoTexto(ObtenEtiqueta(360), True, 'nb_programa', $nb_programa, 50, 50, !empty($nb_programa_err)?$nb_programa_err:NULL);
  Forma_Espacio( );
  // Forma_CampoTexto(ObtenEtiqueta(362), True, 'ds_tipo', $ds_tipo, 50, 20, $ds_tipo_err);
  Forma_CampoTexto(ETQ_ORDEN, True, 'no_orden', $no_orden, 3, 5, !empty($no_orden_err)?$no_orden_err:NULL);
  Forma_CampoTexto(ObtenEtiqueta(365), True, 'no_grados', $no_grados, 3, 5, !empty($no_grados_err)?$no_grados_err:NULL);
  Forma_Espacio( );
  Forma_CampoTexto(ObtenEtiqueta(361), True, 'ds_duracion', $ds_duracion, 50, 20, !empty($ds_duracion_err)?$ds_duracion_err:NULL);
  Forma_CampoTexto(ObtenEtiqueta(368), True, 'no_horas', $no_horas, 50, 20, !empty($no_horas_err)?$no_horas_err:NULL);
  Forma_CampoTexto(ObtenEtiqueta(369), True, 'no_semanas', $no_semanas, 50, 20,!empty( $no_semanas_err)? $no_semanas_err:NULL);
  Forma_CampoTexto(ObtenEtiqueta(610), True, 'ds_credential', $ds_credential, 50, 20, !empty($ds_credential_err)?$ds_credential_err:NULL);
  ...
  Forma_CampoSelectBD(ObtenEtiqueta(367), True, 'fl_template', $Query, $fl_template, !empty($fl_template_err)?$fl_template_err:NULL, True);
  Forma_Espacio( );
