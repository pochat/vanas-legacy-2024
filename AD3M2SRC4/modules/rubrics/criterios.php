<?php
  ...
  if(!ValidaPermiso(FUNC_CRITERIO_FAME, PERMISO_EJECUCION)) {
    MuestraPaginaError(ERR_SIN_PERMISO);
    exit;
  }
  
  PresentaHeader();
  PresentaEncabezado(FUNC_CRITERIO_FAME);
          ...
          <div role="widget" class="jarviswidget" id="wid-id-list" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-collapsed="false">
              ...
              <div role="content">
                  ...
                  <div class="jarviswidget-editbox">
                      ...
                      <input class="form-control" type="hidden" id="fl_funcion" value="<?php echo FUNC_CRITERIO_FAME; ?>">	
                  </div>
                  <!-- end widget edit box -->
                          ...
                          <thead>
                              <tr>
                                 <th></th>
                                   ...
                                   <th><?php echo ObtenEtiqueta(1656); ?></th>
								  <th>  <?php echo ObtenEtiqueta(1657); ?></th>
                                  <th><?php echo ObtenEtiqueta(1658); ?></th>
                                  <th><?php echo ObtenEtiqueta(1659); ?></th>
                                   <th><?php echo ObtenEtiqueta(1660); ?></th>
                                 
                                  <th><?php echo ObtenEtiqueta(1661); ?></th>
								  <th></th>
...
<div style="width: 228px; right: 0px; display: block; padding:0px 50px 10px 0px;" outline="0" class="ui-widget ui-chatbox">
          <a href="javascript:Envia('criterios_frm.php', '');" class="btn btn-primary btn-circle btn-xl" title="Add record" style="color:#FFFFFF;"><i class="fa fa-plus"></i></a>
        </div>
    ...
    $(document).ready(function () {
      ...
      var table = $('#example').on('processing.dt', function (e, settings, processing) {
          ...
          "columns": [
              ...
              { "data": "name_criterio" ,"orderable": false },
              { "data": "name" },
              { "data": "desc_uno" },
              { "data": "desc_dos" },
              { "data": "desc_tres" },
