                ...
                <table class="table table-bordered" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Nom du programme</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Date de début</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Grade</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Le moment d'aller en classe</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Fuseau horaire</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            ...
                            <td>
                                <?php
                                    ...
                                    for ($iii = 1; $rowww = RecuperaRegistro($rs2); $iii++) {
                                        ...
                                        $Wqe = "SELECT CASE WHEN cl_dia='1' THEN 'Lundi'
								                WHEN cl_dia='2' THEN 'Mardi'
								                WHEN cl_dia='3' THEN 'Mercredi'
								                WHEN cl_dia='4' THEN 'Jeudi'
								                WHEN cl_dia='5' THEN 'Vendredi'
								                WHEN cl_dia='6' THEN 'Samedi'
                                                WHEN cl_dia='7' THEN 'Dimanche' 
								                ELSE 'Dimanche' END dia ,no_hora,ds_tiempo
