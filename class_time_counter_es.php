...
#Recovery templates.
$Queryt = "SELECT ds_encabezado_esp,ds_cuerpo_esp,ds_pie FROM k_template_doc WHERE fl_template=222 ";
$rowt = RecuperaValor($Queryt);
$ds_encabezado = html_entity_decode($rowt[0]);
$ds_cuerpo = html_entity_decode($rowt[1]);
$ds_pie = html_entity_decode($rowt[2]);

$ds_template = $ds_encabezado . $ds_cuerpo . $ds_pie;
        ...
        <div class="col-md-12">
            <div id="js-clock" class="row js-clock">
                <div class="col-md-3 box-2">
                    <div id="js-clock-days" class="clock-number-2">00</div><div class="clock-label-2">Dias</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-hours" class="clock-number-2">00</div><div class="clock-label-2">Horas</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-minutes" class="clock-number-2">00</div><div class="clock-label-2">Minutos</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-seconds" class="clock-number-2">00</div><div class="clock-label-2">Segundos</div>
                </div>
            </div>
        </div>
    </div>
