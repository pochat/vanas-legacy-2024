                ...
                <table class="table table-bordered" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Nome del programma</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Data d'inizio</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Grado</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Orario di lezione</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Fuso orario</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            ...
                            <td>
                                <?php
                                    ...
                                    for ($iii = 1; $rowww = RecuperaRegistro($rs2); $iii++) {
                                        ...
                                        $Wqe = "SELECT CASE WHEN cl_dia='1' THEN 'Lunedi'
								              WHEN cl_dia='2' THEN 'Martedì'
								              WHEN cl_dia='3' THEN 'Mercoledì'
								              WHEN cl_dia='4' THEN 'Giovedi'
								              WHEN cl_dia='5' THEN 'Venerdì'
								              WHEN cl_dia='6' THEN 'Sabato'
                                              WHEN cl_dia='7' THEN 'Domenica' 
								              ELSE 'Domenica' END dia ,no_hora,ds_tiempo
