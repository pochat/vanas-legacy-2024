...
#Recovery templates.
$Queryt = "SELECT ds_encabezado,ds_cuerpo,ds_pie FROM k_template_doc WHERE fl_template=222 ";
        ...
        <div class="col-md-12">
            <div id="js-clock" class="row js-clock">
                <div class="col-md-3 box-2">
                    <div id="js-clock-days" class="clock-number-2">00</div><div class="clock-label-2">Days</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-hours" class="clock-number-2">00</div><div class="clock-label-2">HOUrs</div>
                </div>
                <div class="col-md-3 box-2">
