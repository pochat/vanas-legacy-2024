          ...
          if($fg_paso==19){
            ...
            $paso.="
             ...
             //if($fl_pais_selected==226){
                 ...
                 if($fg_total_programa==1){
                     $convenience_fee=(($mn_app_fee+$mn_tuition+$app_fee_taxes)*$convenience_fee_percentage)/100;
                 }else{
             ...
             //}
                    $paso.="
								<tr>
									...
									<td id='td_total'>$".number_format(($mn_total + $convenience_fee) ,2)."</td>
								</tr>								
							</tbody>
						</table>
					</div>";
            ...
            // if($fl_pais_selected==226){
                ...
                ";
                 ...
                 $paso.="<input type='hidden' name='currency' id='currency' value='USD' >";
                ...
                // $paso.="   <button class='btn btn-primary' style='color:#00c3ff;background:#fff;border: 1px solid #ccc;height: 36px !important;margin-left: -10px !important;' onclick='CouponDiscount();' >Apply</button> ";
                 $paso.="   </div>";
                 $paso.="</div>";
                 $paso.="<button type='submit' id='payButton' style='width:80%;background:#00c3ff;'  class='btn btn-primary '><b>PAY NOW  $".number_format(($mn_due_pagar + $app_fee_taxes + $convenience_fee),2)." USD</b></button>";
                 ...
                 $paso.="<script>
                            ...
                            function CouponDiscount(){
                                ...
                                .done(function(result){
                                    ...
                                    var tuition =($mn_app_fee + $mn_tuition )- discount
                                    if(result.success==1){
