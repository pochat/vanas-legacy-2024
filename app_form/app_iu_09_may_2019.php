<?php
  ...
  $fg_study_permit_other = RecibeParametroHTML('fg_study_permit_other'); 
  ...
  $ds_a_email = RecibeParametroHTML('ds_a_email');$_POST[''];
  ...
  if($fg_nueva==true){
    ...
    $QueryS .= "(cl_sesion, fg_app_1, fe_ultmod) ";
    $QueryS .= "VALUES ('".$clave."', '1', CURRENT_TIMESTAMP)";
    $fl_sesion = EjecutaInsert($QueryS);
  }
  else{
    $QueryS  = "UPDATE c_sesion SET fg_app_1='1', fe_ultmod=CURRENT_TIMESTAMP ";
  ...
  if($fg_paso==1){
    ...
    if($fg_new_ses==true) {
      ...
      $Queryf1 .= "(cl_sesion, fl_programa, fl_periodo, ds_fname, ds_mname, ds_lname, ds_email, ds_number, fe_birth, fe_ultmod, cl_recruiter, fg_email) ";
      $Queryf1 .= "VALUES ('$clave', 0, 0, '$ds_fname', '$ds_mname', '$ds_lname', '$ds_email', '$ds_number', '', CURRENT_TIMESTAMP, 0, '1')";    
    }
    else {
      ...
      echo $Queryf1 .= "WHERE cl_sesion='$clave'";    
    }
    ...
    if($row[0]==0){
      ...
      $link = ObtenConfiguracion(121)."/app_form?c=A99".$fl_sesion."f0rm";
  ...
  if($fg_paso==2){
    ...
    for($i = 1; $i <= $no_contratos_ceil; $i++) {
      ...
      $Query .= "ds_p_name, ds_education_number, ds_usual_name, no_weeks ) ";
      ...
      $Query .= " '$ds_usual_name', $weeks_contrato ) ";
      EjecutaQuery($Query);
    }	
	$Queryf1  = "UPDATE k_ses_app_frm_1 SET fl_programa=$fl_programa, fl_periodo=$fl_periodo, ds_ruta_foto='".$ds_ruta_foto."' ";
  ...
  if($fg_paso==3){
      ...
      $Queryf1 = "UPDATE k_ses_app_frm_1 SET ds_alt_number='".$ds_alt_number."', ds_link_to_portfolio='".$ds_link_to_portfolio."', fg_gender='".$fg_gender."', fe_birth='".$fe_birth."' ,ds_ruta_foto_permiso='".$ds_ruta_foto_permiso."',fe_start_date='".$fe_start_date."',fe_expirity_date='".$fe_expirity_date."' ,nb_name_institutcion='".$nb_name_institutcion."'     WHERE cl_sesion='".$clave."'";
    
    for($i = 1; $i <= $no_contratos_ceil; $i++) {
      $Query = "UPDATE k_app_contrato SET fg_international='".$fg_international."', ds_citizenship='".$ds_citizenship."', fg_study_permit='".$fg_study_permit."', fg_study_permit_other='".$fg_study_permit_other."', ds_a_email='".$ds_a_email."' WHERE cl_sesion='".$clave."' ";      
      EjecutaQuery($Query);
    }    
  ...
  if($fg_paso==5){
    for($i = 1; $i <= $no_contratos_ceil; $i++) {
      $Query = "UPDATE k_app_contrato SET  ds_m_add_number='".$ds_m_add_number."', ds_m_add_street='".$ds_m_add_street."', ds_m_add_city='".$ds_m_add_city."', ds_m_add_state='".$ds_m_add_state."', ds_m_add_zip='".$ds_add_zip."', ds_m_add_country='".$ds_m_add_country."' WHERE cl_sesion='".$clave."' ";      
      EjecutaQuery($Query);
    }
  }
  ...
  if($fg_paso==8){
    $Queryf1 = "UPDATE k_ses_app_frm_1 SET fg_responsable='".$fg_responsable."' WHERE cl_sesion='".$clave."'";
    if($fg_responsable==0){
  ...
  if($fg_paso==13){
    ...
    if($fg_nueva4) {
      ...
      $Queryf4 .= "'$fg_resp_1_1', '$fg_resp_1_2', '$fg_resp_1_3', '$fg_resp_1_4', '$fg_resp_1_4', '$fg_resp_1_6', CURRENT_TIMESTAMP)";
    }
    else {
  ...
  function EnviarEmailForms($clave,$email_f1=true,$fg_paso=''){
    ...
    $QueryE .= "nb_programa, nb_periodo, e.ds_pais ";
    $QueryE .= "FROM k_ses_app_frm_1 a, c_programa b, c_periodo c, c_pais d, c_pais e  ";
    ...
    $QueryC .= "ds_a_email, cl_preference_1, cl_preference_2, cl_preference_3 FROM k_app_contrato WHERE cl_sesion='".$clave."' AND no_contrato=1";
    ...
    if($email==true){
      ...
      # Envia correo de confirmacion al Administrador
      $subject = ObtenEtiqueta(336);
      $message  = "Application form submitted $fe_ultmod<br>";
      if($fg_paypal == '1')
