          ...
          if($fg_paso==10){
            ...
            <div class='tab-pane ".$active10."' id='tab10'>
              ...
              <div class='row padding-top-10'>".Personajes(3)."
                ...
                # ori via
                $names8 = array("fg_ori_via", "fg_ori_via", "fg_ori_via", "fg_ori_via", "fg_ori_via");
                $labels8 = array(ObtenEtiqueta(290), ObtenEtiqueta(291), ObtenEtiqueta(292), ObtenEtiqueta(293),  ObtenEtiqueta(294));
                $vals8 = array("A", "B", "C", "D", "0");
                $scripts8 = array("onClick='javascript:show_hidden(7);'", "onClick='javascript:show_hidden(7);'", "onClick='javascript:show_hidden(7);'", "onClick='javascript:show_hidden(7);'", "onClick='javascript:show_hidden(7);'");
                ...
                $paso .= Forma_CampoTextoBootstrap(ObtenEtiqueta(294), 'ds_ori_other', $ds_ori_other, "6", "text", "fa-internet-explorer", "onkeyup='javascript:show_hidden(7);'", true);
                $paso .= "
                  </div>";
                # ori ref
