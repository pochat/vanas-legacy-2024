...
error_reporting(0);
  ...
  switch($fl_pais_selected){
      ...
      case "226":
          ...
          break;
      case "73":
        $campus_img = "<img class='img-rounded' src='../images/france.png' style='height:20px;'>";
        # Variables Stripe
        $secret_key = ObtenConfiguracion(112);
        $public_key = ObtenConfiguracion(111);
        break;
      case "80":
        $campus_img = "<img class='img-rounded' src='../images/germany.png' style='height:20px;'>";
        # Variables Stripe
        $secret_key = ObtenConfiguracion(112);
        $public_key = ObtenConfiguracion(111);
        break;
      case "199":
        $campus_img = "<img class='img-rounded' src='../images/spain.png' style='height:20px;'>";
        # Variables Stripe
        $secret_key = ObtenConfiguracion(112);
        $public_key = ObtenConfiguracion(111);
        break;
      case "105":
        $campus_img = "<img class='img-rounded' src='../images/italy.png' style='height:20px;'>";
        # Variables Stripe
        $secret_key = ObtenConfiguracion(112);
        $public_key = ObtenConfiguracion(111);
        break;
    case "225":
        $campus_img = "<img class='img-rounded' src='../images/united_kingdom.png' style='height:20px;'>";
        # Variables Stripe
        $secret_key = ObtenConfiguracion(112);
        $public_key = ObtenConfiguracion(111);
        break;
    case "153":
        $campus_img = "<img class='img-rounded' src='../images/new_zealand.png' style='height:20px;'>";
        # Variables Stripe
        $secret_key = ObtenConfiguracion(112);
        $public_key = ObtenConfiguracion(111);
        break;
      default:
        ...
        $opc = array('Canada', 'France', 'Germany', 'Spain', 'USA', 'Italy','United Kingdom','New Zealand');
        $val = array(38, 73, 80, 199, 226, 105,225,153);
 ...
 // }
  ...
  $Query .= ", ds_citizenship, fg_study_permit, fg_study_permit_other, fg_aboriginal, ds_aboriginal, fg_health_condition, ds_health_condition, mn_app_fee, mn_tuition,fg_payment,fl_class_time,mn_costs,tax_mn_cost ";
  ...
  if($fg_international==1){
      ...
      if($fg_payment=='C'){
          if($fl_pais_selected<>38){//usa
              $Query="SELECT mn_app_fee_internacional_combined,mn_tuition_internacional_combined,mn_costs_internacional_combined FROM k_programa_costos_pais WHERE fl_programa=$fl_programa AND fl_pais=$fl_pais_selected ";
          }else{
              $Query="SELECT mn_app_fee_internacional_combined,mn_tuition_internacional_combined,mn_costs_internacional_combined FROM k_programa_costos WHERE fl_programa=$fl_programa ";
          }
      }else{
          if($fl_pais_selected<>38){//usa
              $Query="SELECT mn_app_fee_internacional,mn_tuition_internacional,mn_costs_internacional FROM k_programa_costos_pais WHERE fl_programa=$fl_programa and fl_pais=$fl_pais_selected ";
          }else{
              $Query="SELECT mn_app_fee_internacional,mn_tuition_internacional,mn_costs_internacional FROM k_programa_costos WHERE fl_programa=$fl_programa ";
          }
    ...
    if ($fg_payment == 'C') {
        ...
        if ($fl_pais_selected <> 38) { //usa
            $Query = "SELECT mn_app_fee_combined,mn_tuition_combined,mn_costs_combined FROM k_programa_costos_pais WHERE fl_programa=$fl_programa and fl_pais=$fl_pais_selected ";
        } else {
            $Query = "SELECT mn_app_fee_combined,mn_tuition_combined,mn_costs_combined FROM k_programa_costos WHERE fl_programa=$fl_programa ";
        ...
        if ($fl_pais_selected <> 38) { //usa
            $Query = "SELECT mn_app_fee,mn_tuition,mn_costs FROM k_programa_costos_pais WHERE fl_programa=$fl_programa and fl_pais=$fl_pais_selected ";
        } else {
            $Query = "SELECT mn_app_fee,mn_tuition,mn_costs FROM k_programa_costos WHERE fl_programa=$fl_programa ";
   ...
   # html
    ...
    switch($fg_paso){
        ...
        case 20:
          ...
          $paso.="<br><ul class='demo-btns text-center' style='display:none;'>
                <li>
    ...
    $paso .= "
          ...
          if($fg_paso==1){
            $paso .= "
              <div class='tab-pane  ".$active1."' id='tab1'>
                ...
                # Programa
                $concat = array('a.nb_programa', "' ('",'b.ds_credential',"' '", 'a.ds_duracion',  "')'");
                $Query  = "SELECT DISTINCT ".ConcatenaBD($concat)." 'ds_texto', a.fl_programa ";
                $Query .= "FROM c_programa a ";
                $Query .= "JOIN k_programa_costos b on a.fl_programa=b.fl_programa ";
                $Query .= "WHERE a.fl_programa IN($programas) ";
                $Query .= " GROUP BY a.fl_programa ORDER BY a.nb_programa";
                ...
                if ($fl_pais_selected <> 38 && $fl_pais_selected <> 226) {
                    $opc = array(ObtenEtiqueta(2386)); // Online
                    $val = array('O');
                }
          ...
          if($fg_paso==3){
              ...
              $paso .="<script>
                            ...
                            function pushInmigrations()
                            {
                                if(document.getElementById('fl_immigrations_status').value == 1)
                                {
                                     document.getElementById('lbl_fg_international_1').click();

                                     document.getElementById('fg_international').disabled = true;
                                }else{
                                     document.getElementById('fg_international').disabled = false;
                                }
            ...
            <div class='tab-pane  ".$active3."' id='tab3'>
                ...
                <div class='row padding-top-10'>".Personajes(1)."
                  ...
                  #Inmigration status
                   ...
                   if($fl_pais_selected <> 226 && $fl_pais_selected <> 38)
                   {
                  ...
                  $paso .= Forma_CampoSelectBD_Boostrap(ObtenEtiqueta(2663), "fl_immigrations_status", $Query, $fl_immigrations_status, True, "12", "fa-globe", "onChange='pushInmigrations();'", true);
                  ...
                  if($fl_pais_selected==226){
                    ...
                    switch ($fl_pais_selected) {
                        ...
                        case '38':
                            $etq_inter = ObtenEtiqueta(620)." and foreign";
                        ...
                        case '226':
                            ...
                            break;
                        case '199':
                            $etq_inter = "Are you an International Student?<br>
                                          (International students are defined as non-Spain students and foreign)";

                            //if ($ds_add_country <> 199) {
                            //    $fg_international = "1";
                            //}
                            break;
                        case '73':
                            $etq_inter = "Are you an International Student?<br>
                                          (International students are defined as non-France students and foreign)";

                           // if ($ds_add_country <> 73) {
                           //     $fg_international = "1";
                           // }
                            break;
                        case '80':
                            $etq_inter = "Are you an International Student?<br>
                                          (International students are defined as non-Germany students and foreign)";

                           // if ($ds_add_country <> 80) {
                           //     $fg_international = "1";
                           // }
                            break;
                        case '105':
                            $etq_inter = "Are you an International Student?<br>
                                          (International students are defined as non-Italy students foreign)";
                           // if ($ds_add_country <> 105) {
                           //     $fg_international = "1";
                           // }
                            break;
                        case '225':
                            $etq_inter = "Are you an International Student?<br>
                                                      (International students are defined as non-United Kingdom students foreign)";

                           // if ($ds_add_country <> 225) {
                            //    $fg_international = "1";
                           // }
                            break;
                        case '153':
                            $etq_inter = "Are you an International Student?<br>
                                                      (International students are defined as non-New Zealand students foreign)";
                           // if ($ds_add_country <> 153) {
                           //     $fg_international = "1";
                           // }
                            break;
                        default:
                            $etq_inter = "Are you an International Student?<br>
                                          (International students are defined as non-Canadian students foreign)";
                      ...
                      $paso .= Forma_CampoRadioBootstrap(str_uso_normal($etq_inter), $names, $labels, $vals, $scripts, $fg_international, $editars, "12 padding-10", "inline-group", true);
                  }
                  $citi_hid = "";
                  ...
                  if($fl_pais_selected == 199 || $fl_pais_selected == 80 || $fl_pais_selected == 105 || $fl_pais_selected == 73 || $fl_pais_selected == 225 || $fl_pais_selected == 153)
                  {
                        $et_social = "Social Number (DNI)";

                      //spain
                    if ($fl_pais_selected == 199){
                        $et_social = "DNI Number";
                    }


                     $paso .= Forma_CampoTextoBootstrap($et_social, 'ds_sin', $ds_sin, "18", "", "fas fa-id-card", "onkeyup='javascript:show_hidden(1);'", false);
                  }
                  $paso .= "</div>";
                ...
                /*if ($fg_international == 1) {
                    $paso .= "<script>show_hidden(1);
                                       document.getElementById('fg_international').disabled = true;
                                       document.getElementById('lbl_fg_international_1').style.display = 'none';
          ...
          if($fg_paso==4){
            ...
            <div class='tab-pane ".$active4."' id='tab4'>
                ...
                <div class='row padding-top-10'>".Personajes(1)."
                  ...
                  if($fl_immigrations_status==1){ #esta diciendo inmigration ststaus es residente canada su direccion debe rs forzosamente residente camada.

                      if($fl_pais_selected == 226){
                          $Query  = "SELECT ds_pais, fl_pais FROM c_pais WHERE fl_pais=226  ORDER BY ds_pais";
                      }
                      if($fl_pais_selected == 38){
                          $Query  = "SELECT ds_pais, fl_pais FROM c_pais WHERE fl_pais=38  ORDER BY ds_pais";
                      }
                      if ($fl_pais_selected <> 38 && $fl_pais_selected <> 226) {
                            $Query = "SELECT ds_pais, fl_pais FROM c_pais WHERE fl_pais=$fl_pais_selected  ORDER BY ds_pais";
                      }
...
#                  $paso .= Forma_SeccionBootstrap(ObtenEtiqueta(621));
    ...
    */
     ...
     #             $paso .="</div>";
          ...
          if($fg_paso==19){
            ...
            switch ($fl_pais_selected) {
                ...
                case '199':
                    $currency_code = "EUR";
                    $symbol = "<img src='" . SP_IMAGES . "/euro_symbol.png' style='width: 12px;margin-bottom: 3px;'>";
                    $symbol_button_stripe = "<img src='" . SP_IMAGES . "/euro_symbol_white.png' style='width: 16px;margin: 3px;margin-bottom: 3px;'>";
                    break;
                case '73':
                    $currency_code = "EUR";
                    $symbol = "<img src='" . SP_IMAGES . "/euro_symbol.png' style='width: 12px;margin-bottom: 3px;'>";
                ...
                case '105':
                    $currency_code = "EUR";
                    $symbol = "<img src='" . SP_IMAGES . "/euro_symbol.png' style='width: 12px;margin-bottom: 3px;'>"; //nose puede colocar symbolo se rompe.
                    $symbol_button_stripe = "<img src='" . SP_IMAGES . "/euro_symbol_white.png' style='width: 16px;margin: 3px;margin-bottom: 3px;' >";
                    break;
                case '225':
                    $currency_code = "GBP";
                    $symbol = "<img src='" . SP_IMAGES . "/libra_symbol.png' style='width: 12px;margin-bottom: 3px;'>"; //nose puede colocar symbolo se rompe.
                    $symbol_button_stripe = "&pound;";
                    break;
                case '153':
                    $currency_code = "NZD";
                    $symbol = "$"; //nose puede colocar symbolo se rompe.
                    $symbol_button_stripe = "<img src='" . SP_IMAGES . "/euro_symbol_white.png' style='width: 16px;margin: 3px;margin-bottom: 3px;' >";
                    break;
                default:
                    $Query = "SELECT currency_code FROM c_pais WHERE fl_pais=$fl_pais_selected  ";
                    $row = RecuperaValor($Query);
            ...
            if ($fl_pais_selected <> 226 && $fl_pais_selected<>38)
            {
                $Queryd .= "FROM k_programa_costos_pais where fl_programa=$fl_programa and fl_pais=$fl_pais_selected  ";
            }else{
              ...
              <div class='row padding-top-10' style='padding:20px;'>".Personajes(5)."
                ...
                // }
                 if($fl_pais_selected<>38){
                     ...
                     $etq_info= str_replace("#app_fee_international#", $symbol."".$mn_app_internacional." ".$currency_code, $etq_info);
                     $etq_info= str_replace("#app_fee#", $symbol."".$mn_app_fee." ".$currency_code." ", $etq_info);
		...
		//			$paso.=ObtenEtiqueta(2292);
         //    }else{
           ...
           //       }
            ...
            $Queryapp = "SELECT tax_mn_cost,ds_costs,mn_costs FROM k_app_contrato WHERE cl_sesion='$clave' ";
            ...
            $paso.="
							...
							<tbody>
								<tr>
									...
									<td> " . $symbol . "".$mn_app_fee."</td>
								</tr>
								<tr id='tr_descuento' class='hidden' style='color:#0091d9;'>
									<td colspan='3'>".ObtenEtiqueta(2295)."</td>
									<td>".ObtenEtiqueta(2299)."</td>
									<td id='td_descount'>". $symbol."".number_format($mn_descuento,2)."</td>
								</tr>
								<tr>
									<td colspan='4'>".ObtenEtiqueta(2296)."
                        ";
                        if ($fg_total_programa == 1) {
                            if ($tax_mn_cost > 0) {
          $paso .= "            <br><small>(Include Vanas+ Learning Resources $symbol $mn_costs)</small>    ";
                            }
                        }


          $paso.="                </td>
									<td id='td_tuiton'>" . $symbol . "".number_format($mn_tuition,2)."</td>
								</tr>
                        ";
          ...
          //   if($fl_pais_selected==226){
                 ...
                 if($fg_total_programa==1){
                     ...
                     $sumat=$mn_app_fee+$mn_tuition+$app_fee_taxes+ $tax_mn_cost;
                 ...
                 if($fg_total_programa == 1){
                     ...
                     if($tax_mn_cost>0){
                        ...
                        $paso .= "    <tr>
									<td colspan='4'>Tax Vanas+ Learning Resources</td>
									<td><span id='learning_resources' > " . $symbol . "" . number_format($tax_mn_cost, 2) . "</span></td>
								</tr>";
                    }
                    ...
                    $paso.="    <tr>
									...
									<td><span id='discount_stripe' > " . $symbol . "".number_format(0,2)."</span></td>
								</tr>";
                    $paso.="    <tr>
									<td colspan='4'>Tax ($percentage_tax %)</td>
									<td>" . $symbol . "".number_format($app_fee_taxes,2)."</td>
								</tr>";

                    $paso.="    <tr>
									<td colspan='4'>Convenience fee </td>
									<td>" . $symbol . "".number_format($convenience_fee,2)."</td>
								</tr>";
                    ...
                    if ($fg_total_programa == 1) {
                     $paso .= "
								<tr>
									...
									<td id='td_total'>" . $symbol . "" . number_format(($mn_total + $app_fee_taxes + $convenience_fee+ $tax_mn_cost), 2) . "</td>
								</tr>
                            ";
                    } else {
                        ...
                        $paso .= "
								    <tr>
									    <td colspan='4'>" . ObtenEtiqueta(2297) . "</td>
									    <td id='td_total'>" . $symbol . "" . number_format(($mn_total + $app_fee_taxes + $convenience_fee), 2) . "</td>
								    </tr>
                                ";
                    }
          ...
          /*
             ...
             */
                ...
                $paso.=" <input type='hidden' name='tax_mn_cost' id='tax_mn_cost' value='$tax_mn_cost'>";
                ...
                if($fg_total_programa==1) {
                    ...
                    $paso.="<button type='submit' id='payButton' style='width:80%;background:#00c3ff;'  class='btn btn-primary '><b>PAY NOW  " . $symbol_button_stripe . "".number_format(($mn_due_pagar + $app_fee_taxes + $convenience_fee+ $tax_mn_cost),2)." ".$currency_code." </b></button>";

                }else{

                    $paso .= "<button type='submit' id='payButton' style='width:80%;background:#00c3ff;'  class='btn btn-primary '><b>PAY NOW  " . $symbol_button_stripe . "" . number_format(($mn_due_pagar + $app_fee_taxes + $convenience_fee), 2) . " " . $currency_code . " </b></button>";
    ...
    $paso .="<br><div id='payment_process' class='dot-elastic hidden text-center' style='margin: auto;padding-top: 10px;margin-top: 15px;'></div><br><div id='msg_succes' class='alert alert-success text-center hidden' role='alert'>
                 ...
                 $paso.="
                            ...
                            //let names_=document.getElementById('name').value;
                            //let emails_=document.getElementById('email').value;
                            ...
                            form.addEventListener('submit', function(event) {
                              ...
                              event.preventDefault();
								$('#payment_process').removeClass('hidden');
                           ...
                           function stripePaymentMethodHandler(result) {
                                  ...
                                  $('#msg_process').removeClass('hidden');
                                  $('#payment_process').removeClass('hidden');
                                   payButton.disabled = true;
                                    var paymentMethodId = result.paymentMethod.id;
                                    var forma = $('#frm_stripe');
                                    forma.append($('<input type=\"hidden\" name=\"stripepaymentMethodId\" />').val(paymentMethodId));
                                    ...
                                    .done(function(result2){
                                        ...
                                        var requires_action=stripe_result.requires_action;


                                        if(error){
                                             $('#msg_process').addClass('hidden');
                                             alert(error);
                                             payButton.disabled = false;
                                             $('#payment_process').addClass('hidden');
                                        }else{
                                            ...
                                            if(requires_action){
                                                ...
                                                stripe.handleCardAction(payment_intent_client_secret).then(handleStripeJsResult);
                                                ...
                                                setTimeout(function redirect(){
													window.location.href = 'https://campus.vanas.ca/app_form/finished.php';
												},5000);
                           ...
                           function handleStripeJsResult(result) {
                              if (result.error) {
                                ...
                                //ms confirmamndo pago

                                $.ajax({
                                    type: 'POST',
                                    url: 'payment_stripe_require_action_success.php',
                                    async: false,
                            ...
                            function CouponDiscount(){
                                ...
                                .done(function(result){
                                    ...
                                    if(result.success==1){
                                        ...
                                        $('#payButton').empty();
                                        $('#payButton').append('PAY NOW $'+new Intl.NumberFormat('en-IN').format(parseFloat(tuition).toFixed(2))+' $currency_code');
  ...
  if($fg_paso==1989){
      ...
      $paso.="  <h1>Select Campus/Region</h1>";
      $paso.="  </div>";
      $paso.="</div>";
      ...
      $paso.="
            <form action='index.php' method='post' novalidate='novalidate'>
              ...
              <input type='hidden' id='rela_other' name='rela_other' value='".ObtenEtiqueta(2254)."'>";
      $paso.="<div class='row'>";
      $paso .= "    <div class='col-md-4'> ";
      $paso .= "    </div>";
      $paso .= "    <div class='col-md-4'> ";

      $opc = array('Canada','France','Germany','Spain','USA','Italy','United Kingdom','New Zealand');
      $val = array(38,73,80,199,226,105,225,153);
      $paso .= Forma_CampoSelect_Boostrap('Campus', "fl_pais_selected", $opc, $val, $fl_pais_selected, True, "12", "fa-globe", "onchange='DisableButton();'", true);


      $paso.="      <div class='text-center' id='btn_accept' style='display:none;'><button type='submit' onclick='Send();' class='btn btn-primary' style='background:#337ab7;margin:auto;'>Accept</button></div>";
      ...
      $paso.="<script>
                ...
                {
                    if(document.getElementById('fl_pais_selected').value>0){
