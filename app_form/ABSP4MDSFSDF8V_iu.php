<?php
  ...
  if($fg_international==1 AND empty($ds_citizenship)){
    $ds_citizenship_err = ERR_REQUERIDO;
  }
  if($fg_study_permit==0 AND $fg_study_permit_other==''){
    $fg_study_permit_other_err = ERR_REQUERIDO;
  }
  ...
  $fg_error = $fg_error || $ds_citizenship_err || $fg_study_permit_other_err;
  ...
  if($fg_error) {
    ...
    // Forma_CampoOculto('ds_health_condition_err', $ds_health_condition_err);
...
<script>
  ...
  if($fg_nueva) {
    ...
    $Query .= "fg_ori_via, ds_ori_other, fg_ori_ref, ds_ori_ref_name, ds_ruta_foto, fe_ultmod, fg_responsable, cl_recruiter,fg_disability,ds_disability) ";
    $Query .= "VALUES ('$cl_sesion', $fl_programa, $fl_periodo, ";
    $Query .= "'$ds_fname', '$ds_mname', '$ds_lname', '$ds_number', '$ds_alt_number', '$ds_email','$ds_link_to_portfolio', '$fg_gender', $fe_birth, ";
    $Query .= "'$ds_add_number', '$ds_add_street', '$ds_add_city', '$ds_add_state', '$ds_add_zip', '$ds_add_country', ";
    $Query .= "'$ds_eme_fname', '$ds_eme_lname', '$ds_eme_number', '$ds_eme_relation', '$ds_eme_country', ";
    $Query .= "'$fg_ori_via', '$ds_ori_other', '$fg_ori_ref', '$ds_ori_ref_name','$ds_ruta_foto', CURRENT_TIMESTAMP, '$fg_responsable', $cl_recruiter,'$fg_disabilityie','$ds_disability')";
    ...
    $Query .= "fe_ultmod=CURRENT_TIMESTAMP, ds_ruta_foto='$ds_ruta_foto', fg_responsable='$fg_responsable', cl_recruiter='$cl_recruiter', fg_disability='$fg_disabilityie',ds_disability='$ds_disability'  ";
    $Query .= "WHERE cl_sesion='$clave'";
  ...
  for($i = 1; $i <= $no_contratos_ceil; $i++) {
    ...
    $Query .= "ds_m_add_country, ds_a_email, no_weeks, ds_usual_name ";
    ...
    $Query .= " $weeks_contrato, '$ds_usual_name' ";
    $Query .= ", '$ds_citizenship', '$fg_study_permit', '$fg_study_permit_other', '$fg_aboriginal', '$ds_aboriginal', '$fg_health_condition', '$ds_health_condition' ) ";
    EjecutaQuery($Query);
  }
