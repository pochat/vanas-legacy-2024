<?php
  ...
  if($fg_paso==1){
    ...
    $Query_country = 'UPDATE k_ses_app_frm_1 SET ds_add_country="'.$ds_add_country.'", fe_birth="'.$fe_birth.'"  WHERE cl_sesion="'.$clave.'" ';
   ...
   // EjecutaInsert($Querysteps);
    ...
    // copy test development.
    //$email = EnviaMailHTML($smtp, $smtp, "mike@vanas.ca", $subject." Step 1/5", $message);
 ...
 if($fg_international==1){
		  ...
		  if($fg_payment=='C'){#Modalidad Combined
           ...
           switch($fl_pais_selected){      
                case 38:
                    ...
                    break;
                case 226: 
                    $Query .= "FROM k_programa_costos_pais where fl_pais=$fl_pais_selected ";
                    break;
           }
  ...
  if($fg_paso==1){
	...
	$Queryf1  = "UPDATE k_ses_app_frm_1 SET fl_programa=$fl_programa, fl_periodo=$fl_periodo ";
    $Queryf1 .= "WHERE cl_sesion='".$clave."' ";
