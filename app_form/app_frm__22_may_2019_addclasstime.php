<?php
  ...
  $Query .= ", ds_citizenship, fg_study_permit, fg_study_permit_other, fg_aboriginal, ds_aboriginal, fg_health_condition, ds_health_condition, mn_app_fee, mn_tuition,fg_payment ";
  ...
  $mn_app_fee = $row[21];
  $mn_tuition = $row[22];
  $fg_payment=str_texto($row['fg_payment']);
          ...
          if($fg_paso==3){
            ...
            <div class='tab-pane  ".$active3."' id='tab3'>
                ...
                <div class='row padding-top-10'>".Personajes(1)."
                  ...
                  $paso .= "</div>";//end ocultar el intsrnational
             ...
             $paso .= ":</strong></div>	
			  ...
			  $paso .= "
                            ...
                            <form name='frmpaypal' id='frmpaypal' action='$urlPaypal'>
                              ...
                              <input type='hidden' name='return' id='return' value='".$url_campus."/app_form/'>
