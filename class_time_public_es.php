                ...
                <table class="table table-bordered" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Nombre del programa</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Fecha de inicio</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Grado</th>
                            <th scope="col" style="background-color:#0162c9;color: #fff;">Horarios de clase</th>
                            ...
                            <td>
                                <?php
                                    ...
                                    for ($iii = 1; $rowww = RecuperaRegistro($rs2); $iii++) {
                                        ...
                                        $Wqe = "SELECT CASE WHEN cl_dia='1' THEN 'Lunes'
								                WHEN cl_dia='2' THEN 'Martes'
								                WHEN cl_dia='3' THEN 'Miercoles'
								                WHEN cl_dia='4' THEN 'Jueves'
								                WHEN cl_dia='5' THEN 'Viernes'
								                WHEN cl_dia='6' THEN 'Sabado'
                                                WHEN cl_dia='7' THEN 'Domingo' 
								                ELSE 'Domingo' END dia ,no_hora,ds_tiempo
