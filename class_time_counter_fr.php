...
#Recovery templates.
$Queryt = "SELECT ds_encabezado_fra,ds_cuerpo_fra,ds_pie FROM k_template_doc WHERE fl_template=222 ";
        ...
        <div class="col-md-12">
            <div id="js-clock" class="row js-clock">
                <div class="col-md-3 box-2">
                    <div id="js-clock-days" class="clock-number-2">00</div><div class="clock-label-2">Jours</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-hours" class="clock-number-2">00</div><div class="clock-label-2">heures</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-minutes" class="clock-number-2">00</div><div class="clock-label-2">MinS</div>
                </div>
                <div class="col-md-3 box-2">
                    <div id="js-clock-seconds" class="clock-number-2">00</div><div class="clock-label-2">SecS</div>
                </div>
            </div>
        </div>
    </div>
