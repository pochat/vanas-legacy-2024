<?php
  ...
  //define("SP_HOME",      $_SERVER[DOCUMENT_ROOT]."/vanas");
  ...
  //define("PATH_HOME",    "/vanas/AD3M2SRC4");
  define("PATH_HOME",    "/admin");
  ...
  # Rutas para la aministracion NUEVA
  define("PATH_HOME_V2",    "/AD3M2SRC4");
  define("PATH_CSS_V2",     PATH_HOME_V2 . "/css");
  define("PATH_EXPORT_V2",  PATH_HOME_V2 . "/export");
  define("PATH_IMAGES_V2",  PATH_HOME_V2 . "/images");
  define("PATH_JS_V2",      PATH_HOME_V2 . "/js");
  define("PATH_LIB_V2",     PATH_HOME_V2 . "/lib");
  define("PATH_LOGS_V2",    PATH_HOME_V2 . "/logs");
  define("PATH_MODULOS_V2", PATH_HOME_V2 . "/modules");
  define("PATH_TMP_V2",     PATH_HOME_V2 . "/tmp");
