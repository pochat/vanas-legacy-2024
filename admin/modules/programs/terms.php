<?php
  ...
  $Query .= "AND a.fl_periodo=c.fl_periodo AND b.fg_archive='0'  /*AND b.fl_programa<>1*/ ";
  ...
  $Query .= "ORDER BY fe_inicio DESC, nb_programa, no_grado";
 
  # Muestra pagina de listado
  $campos = array(ObtenEtiqueta(380), ObtenEtiqueta(361), ObtenEtiqueta(381), ObtenEtiqueta(375));
  PresentaPaginaListado(FUNC_PERIODOS, $Query, TB_LN_IUD, True, False, $campos);
