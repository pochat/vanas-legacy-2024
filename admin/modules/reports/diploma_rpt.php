<?php
  ...
  $htmlcontent = '
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td style="width:100%; height:290px; text-align:center;">
         &nbsp;
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="width:30%; height:100px; color:#000000; font-family:Arial; font-size:50px; font-weight:normal; text-align:left; border-top:1px solid black;">
         <br/>'.ObtenEtiqueta(530).'
        </td>
      </tr>
    </table>
    ';
