<?php
  ...
  $Query3 .= "ds_pais '".ObtenEtiqueta(287)."',ds_add_state '".ObtenEtiqueta(285)."', IFNULL(fg_earnedd,'0.00') '".ObtenEtiqueta(741)."', 
  ...
  $QueryTST .= "(SELECT ds_add_state FROM k_ses_app_frm_1 t WHERE t.cl_sesion=b.cl_sesion) ds_add_state, ";
  ...
  $QueryAPP .= "(SELECT ds_pais FROM c_pais i WHERE i.fl_pais=b.ds_add_country) ds_pais,ds_add_state, IFNULL('',a.mn_pagado) tobepaid, ";
  ...
  WHEN 6 THEN CONCAT(IF(a.fg_refund='1','Refund',' '),' ','Cash') END ds_metodo_pago, ds_pais, g.ds_add_state, ";
  ...
  $QueryAPPN .= "(SELECT ds_pais FROM c_pais i WHERE i.fl_pais=b.ds_add_country) ds_pais,b.ds_add_state, IFNULL('',a.mn_pagado) tobepaid, ";
  ...
  $nom_arch = PATH_EXPORT."/payments_".date('Ymd')."_".rand(1000,9000).".csv";
  ExportaQuery($nom_arch, $Query3);
