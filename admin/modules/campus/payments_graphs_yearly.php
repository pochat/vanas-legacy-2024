<?php
	...
	<script type='text/javascript'>
      ...
      var charts = $('#charts');
      charts.append('<div id=\"yearly-chart\" style=\"display:none;\"></div>');

			// General config
			var payments = ".json_encode($yearly).";
			var xLabels = ".json_encode($yearlyLabels).";
      ...
      var svg = d3.select('#yearly-chart')
        .append('svg')
