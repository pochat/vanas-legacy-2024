<?php
  ...
  $Query .= "ds_activo '".ObtenEtiqueta(199)."|center', ds_fe_evento '".ObtenEtiqueta(193)."', ds_fijo '".ObtenEtiqueta(161)."|center' ";
  $Query .= "FROM ( ";
  ...
  $Query .= ConsultaFechaBD('fe_evento', FMT_FECHA)." ds_fe_evento, ";
  ...
  $Query .= "AND b.cl_tipo_contenido=".TC_NOTICIA." ";
  ...
  PresentaPaginaListado(FUNC_NOTICIAS, $Query, TB_LN_IUD, True, False, $opc);
