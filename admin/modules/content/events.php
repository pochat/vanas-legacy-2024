<?php
  ...
  $Query  = "SELECT fl_contenido, lb_funcion '".ObtenEtiqueta(154)."', lb_titulo '".ETQ_TITULO."', ";
  $Query .= "ds_fecha '".ObtenEtiqueta(193)."', ds_estado '".ObtenEtiqueta(200)."', ";
  $Query .= "ds_activo '".ObtenEtiqueta(199)."|center', ds_ini '".ObtenEtiqueta(190)."', ds_fijo '".ObtenEtiqueta(161)."|center' ";
  $Query .= "FROM ( ";
  $Query .= "SELECT a.fl_contenido, nb_funcion, tr_funcion, nb_titulo, tr_titulo, a.no_orden no_orden, fe_evento, ";
  ...
  $Query .= ConsultaFechaBD('fe_ini', FMT_FECHA)." ds_ini, ".ConsultaFechaBD('fe_evento', FMT_FECHA)." ds_fecha, ";
  ...
  $Query .= "AND b.cl_tipo_contenido=".TC_EVENTO." ";
  ...
  PresentaPaginaListado(FUNC_EVENTOS, $Query, TB_LN_IUD, True, False, $opc);
