<?php
  ...
  if(!$fg_error) { // Sin error, viene del listado
    if(!empty($clave)) { // Actualizacion, recupera de la base de datos
      $Query  = "SELECT nb_programa, ds_duracion, ds_tipo, no_orden, no_grados, fl_template, fg_fulltime, fg_taxes, fg_total_programa ";
  ...
  Forma_Doble_Fin( );
  Forma_Espacio( );
  Forma_CampoCheckBox(ObtenEtiqueta(698),'fg_total_programa', $fg_total_programa);
  Forma_Espacio( );
