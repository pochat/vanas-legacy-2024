                               ...
                               --->       
								...
								<?php 
                                      ...
                                      if($fg_esta_calificado_teacher){
									   ...
									   $rubric.="        						 <textarea class='form-control' rows='4' id='desc_teacher'  placeholder='".ObtenEtiqueta(1668)."' style='resize:none !important;' maxlength='130' disabled>$ds_comentario_final</textarea>";	
