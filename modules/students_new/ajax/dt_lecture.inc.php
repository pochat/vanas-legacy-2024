<?php
  ...
  // $fl_leccion=19;
  // $ds_vl_ruta = "/Conc_T1_week07_Lecture_web.m3u8";
  ...
  if($nb_tab == 'lecture') {
    ...
    if(($dif >= -1 /*AND $dif < 3*/) AND !empty($ds_vl_ruta)) {
