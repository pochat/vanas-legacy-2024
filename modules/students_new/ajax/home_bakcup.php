...
<!---This list clases live links zoom----->
<div class="panel panel-primary">
    <div class="panel-heading">Global Class</div>
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                <div id="lecture_clases" class="well padding-10 ht-150"></div>
            </div>

            <div class="col-sm-6 col-md-3 col-lg-3">
                <div id="review_clases" class="well padding-10 ht-150"></div>
            </div>
...
<script type="text/javascript">
	...
	// Live Session Panel
	var student, liveSessionPanel, liveSessionExists, liveSessionLink, liveSessionStart, liveSessionClose, liveSessionReadable,liveSessionTitle,LiveSesionGClass;
	var liveSessionExistsGlobal, liveSessionExistsLecture, liveSessionExistsReview,
		liveSessionLinkGoblalC, liveSessionLinkLectureC, liveSessionLinkReviewC,
		liveSessionStartGlobal, liveSessionStartLecture, liveSessionStartReview,
		liveSessionCloseGlobal, liveSessionCloseLecture, liveSessionCloseReview,
		liveSessionReadableGlobal, liveSessionReadableLecture, liveSessionReadableReview,
        liveSessionTitleGlobal,liveSessionTitleLecture,liveSessionTitleReview;
	var student = <?php GetStudentSession($fl_alumno); ?>;
	var student_global =<?php GetStudentSessionGlobalClass($fl_alumno); ?>;
	var student_lecture =<?php GetStudentSessionLectureClass($fl_alumno); ?>;
	var student_review =<?php GetStudentSessionReviewClass($fl_alumno); ?>;

	var liveSessionPanel = $('#live-session');
	LiveSesionGClass = $('#global_clases');
	LiveSesionLClass = $('#lecture_clases');
    LiveSesionRClass = $('#review_clases');
	...
	liveSessionLinkGoblalC = student_global.session.link;
	liveSessionLinkLectureC = student_lecture.session.link;
	liveSessionLinkReviewC = student_review.session.link;
