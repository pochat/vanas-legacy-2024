<?php
  ...
  # Marca leidos los comentarios de esta entrega
  if(!$fg_otro_alumno)
    EjecutaQuery("UPDATE k_com_entregable SET fg_leido='1' WHERE fl_entrega_semanal=$fl_entrega_semanal AND fg_tipo='$fg_tipo'");
