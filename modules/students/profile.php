<?php
  ...
  Forma_Inicia($fl_alumno, True, 'profile_iu.php');
  Forma_CampoInfo('', "<a href='profile_student.php?profile_id=$fl_alumno'>View my Profile</a>");
  ...
  Forma_CampoInfo(ObtenEtiqueta(500), $ds_status);
  Forma_Espacio( );
