		...
		<!-- jQzoom -->
		<script src="<?php echo PATH_COM_JS; ?>/jquery.jqzoom-core.js"></script>
    ...
    ?>
		...
		<!-- board.inc.js -->
		<script src="<?php echo PATH_N_COM_JS; ?>/board.inc.js<?php echo '?date='.date('Ymdhis'); ?>"></script>
		...
		<!-- desktop.inc.js -->
		<script src="<?php echo PATH_N_COM_JS; ?>/desktop.inc.js<?php echo '?date='.date('Ymdhis'); ?>"></script>
