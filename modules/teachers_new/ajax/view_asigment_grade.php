  ...
  $contador=0;
			  ...
			  if(!empty($row3[0])){
				...
				if($fg_ref_sketch == '1')
				  $ds_ref_sketch = "Sketch reference";
					...
					# Inicia bloque de Programa - Grado
                     ...
                     // echo "<p class='text-center' style='font-size:14px; margin:0; font-weight:250;'>Group $nb_grupo</p> "; 
					...
					echo"	<div class='jarviswidget' id='id5' data-widget-editbutton='false' data-widget-colorbutton='false' data-widget-togglebutton='false'  >";
				...
				while($row2 = RecuperaRegistro($rs2)) {
				  ...
				  echo "	                 <td class='text-center'>";					  
											  ...
											  if($fg_nuevo_alumno==1){
														...
														if(!empty($lesson_have_rubric))
															echo"<a class='btn btn-primary'  OnClick='AsignarCalificacion$fl_entrega_semanal();'><i class='fa fa-pencil'></i> ".ObtenEtiqueta(1976)."</a> ";
														else
											...
											<script>
											   function AsignarCalificacion$fl_entrega_semanal(){
				  ...
				  echo"					    </td>
						...
						";				  
			    }#end wile registros de la tabla	
					...
					echo"					 
								...
								echo"			
									...
									$(document).ready(function(){
									  $('#tbl_".$contador."').dataTable({ responsive: true,  'bSort': true, 'bLengthChange': true, 'bPaginate': true,iDisplayLength:10,});
									});
									</script>
								";
   ...
   if(empty($tot_registros)){
       ...
       echo"<div class='row'>
                    ...
                    <br><br>
                    <img src='".SP_IMAGES."/".ObtenNombreImagen(305)."'>
                    <br><br>
                    <h1>".str_uso_normal(ObtenEtiqueta(2123))."</h1>
                    </div>
            </div>";
