<?php
 ...
 //echo"<div id='presenta_rub' name='presenta_rub'></div>";
  ...
  $contador=200;
				  ...
				  ";					  
											  ...
											  if($fg_nuevo_alumno==1){
														 ...
														 if(!empty($lesson_have_rubric)){
																 ...
																 echo"<a class='btn btn-primary'  OnClick='VerCalificacion(".$fl_entrega_semanal.", ".$fl_alumno.", ".$fl_leccion.", ".$fl_grupo.", ".$fl_semana.", ".$no_semana.", ".$fl_programa.", ".$no_grado.");'><i class='fa fa-pencil'></i> ".ObtenEtiqueta(1975)."</a> ";
                             }
															else
											...
											echo"
													...
													<script>
                          function VerCalificacion(flentre, std, flec, grp, flsem, nosem, pro, gra ){
   ...
   echo"                                          
                                                    <script>
                                                    function AsignarCalificacion2(fl_entrega_semanal,fl_alumno,fl_leccion,fl_grupo,fl_semana,fl_programa,no_grado,no_semana) {
