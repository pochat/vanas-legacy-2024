		...
		<span>
			<div class="bar-holder no-padding">
				...
				<div class="progress progress-xs">
					<div id="notification-week-bar" class="progress-bar bg-color-blueDark"></div>
				</div>
			</div>
		</span>
	</li>
	<li>
		<span>
			<div class="bar-holder no-padding">
				...
				<div class="progress progress-xs">
					<div id="notification-A-bar" class="progress-bar bg-color-blue"></div>
				</div>
			</div>
		</span>
	</li>
	<li>
		<span>
			<div class="bar-holder no-padding">
				...
				<div class="progress progress-xs">
					<div id="notification-AR-bar" class="progress-bar bg-color-blue"></div>
				</div>
			</div>
		</span>
	</li>
	<li>
		<span>
			<div class="bar-holder no-padding">
				...
				<div class="progress progress-xs">
					<div id="notification-S-bar" class="progress-bar bg-color-greenLight"></div>
				</div>
			</div>
		</span>
	</li>
	<li>
		<span>
			<div class="bar-holder no-padding">
				...
				<div class="progress progress-xs">
					<div id="notification-SR-bar" class="progress-bar bg-color-greenLight"></div>
				</div> 
			</div>
		</span>
	</li>
