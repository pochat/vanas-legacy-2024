...
<!--
window.open(\"".PAGINA_NOD_MAE."?node=$nodo\");
history.go(-1);
//-->
</script>
</head></html>";
          ...
          $direccion = "Location: ".PAGINA_NOD_MAE."?node=$nodo";
          header($direccion);
          exit;
        }
      }
...
<script type='text/javascript'>
<!--
window.open(\"".PAGINA_CON_MAE."?page=$pagina\");
history.go(-1);
//-->
</script>
</head></html>";
          ...
          $direccion = "Location: ".PAGINA_CON_MAE."?page=$pagina";
          header($direccion);
          exit;
        }
      }
