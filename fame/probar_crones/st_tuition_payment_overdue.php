<?php
   ...
   SendNoticeMail($client, $from, 'gflore2702@gmail.com', "", "Tuition Payment Overdue", "test gabriel yahoooooo");
   echo "echkkoajksnaq ";
exit;
   // mail('gflores2702@gmail.com','test gabito','Holaaaaaa');
	...
	$Query .= "AND DATE_SUB(CURDATE(), INTERVAL $day_late_period DAY) <= DATE(a.fe_pago) ";exit;
    ...
    AND e.fg_opcion_pago=$no_opcion AND d.fg_activo='1' ";
        ...
        SendNoticeMail($client, $from, $ds_email, $ds_email_r, "Tuition Payment Overdue", $ds_template_html);
			}
		}
	}
?>
