<?php
  ...
  define("FG_PRODUCCION", True);
  if(FG_PRODUCCION) {
    define("DATABASE_USER",  "dev");
    define("DATABASE_PWD",   "D#v3L0p3rr");
    define("INICIO_W",       "/");
    define("CMD_FFMPEG",     "/usr/local/bin/ffmpeg");
    ...
    define("FFMPEG_CMD", "/usr/local/bin/ffmpeg -i ");
    define("SOX_CMD", "/usr/local/bin/sox ");
  }
  else {
    define("DATABASE_USER", "root");
    define("DATABASE_PWD",  "loomtek");
