...
<html xmlns='http://www.w3.org/1999/xhtml'>
	...
	<header id="vanas-header">
		<div id="logo-group" class="pull-left">
			...
			<!-- LOGO -->
			<span id="logo"><img src="<?php echo PATH_SELF_IMG; ?>/logo.jpg" alt="Vanas Logo"></span>
			<span id="activity" class="activity-dropdown pull-left"> <i class="fa fa-user"></i> <b class="badge">0</b> </span>

			<div class="ajax-dropdown">
				<div class="btn-group btn-group-justified" data-toggle="buttons">
					<label class="btn btn-default">
						<input type="radio" name="activity" id="notify/messages.php">
						Messages <span class='notice-count'></span>
					</label>
					<label class="btn btn-default active">
						<input type="radio" name="activity" id="notify/notifications.php">
						Notices <span class='notice-count'></span>
					</label>
					<label class="btn btn-default">
						<input type="radio" name="activity" id="notify/progress.php">
						Progress 
					</label>
				</div>
