	...
	switch($cl_template) {
		case TMPL_LIGA:
			if(!empty($nodo)) {
		    	...
		    	/*echo 
		    		"<script type='text/javascript'>
		    			location.hash = '#public/node.php?node=$nodo';
		    		</script>";
            echo 
		    		"<script type='text/javascript'>
		    			location = 'index.php#public/node.php?node=$nodo';
		    		</script>";*/
            echo 
		    		"<script type='text/javascript'>
		    			location = '".PATH_SELF_SITE."/node.php?node=$nodo';
		    		</script>";
		    }
		  }
		  elseif(!empty($pagina)) {
		  	if($fg_ventana) {
		    	...
		    	echo 
		    		"<script type='text/javascript'>
		    			location.hash = '#public/content.php?page=$pagina';
	    			</script>";
		    }
		  }
		  elseif(!empty($ds_ruta)) {
		  	if($fg_ventana) {
		    	...
		    	echo 
		    		"<script type='text/javascript'>
		    			location = '".PATH_SELF_SITE."/$ds_ruta';
	    			</script>";
		    }
		  }
		  else {
