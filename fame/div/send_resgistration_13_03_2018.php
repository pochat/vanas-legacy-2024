<?php
  ...
  if($mail)
  {
      ...
      $Query="INSERT INTO k_envio_email_reg_selfp (ds_first_name,ds_last_name,ds_email,no_registro,fg_confirmado,fg_tipo_registro,fl_invitado_por_instituto,fe_alta,fe_ultmod)"; 
      $Query.="values('$ds_first_name','$ds_last_name','$ds_email','$no_codigo_confirmacion','0','A','$fl_invitado_por',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)";
      EjecutaInsert($Query);
