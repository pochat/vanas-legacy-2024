...
//echo"<script>alert('1');</script>";
 ...
 $Query .= "VALUES('$ds_login', '".sha256($ds_pass)."','$ds_alias', '$cl_sesion_nueva', '$fg_activo', CURRENT_TIMESTAMP, 0, ";
 $Query .= "'$ds_nombres', '$ds_apaterno','$ds_email', ";
 if($fl_perfil_sp==PFL_ESTUDIANTE_SELF)
 ...
 if($fg_desbloquear_curso==1){
     ...
     EjecutaQuery("UPDATE c_usuario SET fg_b2c='1',fg_system='F' WHERE fl_usuario=$fl_usuario_sp ");
...
#Se genera su direccion , por el momento solo es su fl_sp.
 ...
 $Query="UPDATE c_usuario SET ds_login='$ds_login3',fg_system='F' WHERE fl_usuario=$fl_usuario_sp ";
 EjecutaQuery($Query);
