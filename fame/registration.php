		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-8" data-widget-editbutton="false" data-widget-custombutton="false">
						...
						<div  name="contact-form" id ="contact-form" class="smart-form">
                            ...
                            $title=ObtenEtiqueta(907);
							$cadena=ObtenEtiqueta(908);
                            $cadena= str_replace("#no_day_trials#", "".$no_dias_permitidos_para_modo_trial, $cadena); # first name a quein se le envia el correo
                            $title2=str_replace("#no_users_trial#", "".$no_usuarios_maximos_trial, $cadena);
								...
								<div class="row" id="formulario">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-lg-8" >
                                       <section>
                                            ...
                                            <input id="ds_firts_name" name="ds_firts_name" type="text">
                                        ...
                                        <section>
                                            ...
                                            <input id="ds_last_name" name="ds_last_name" type="text">
