<?php 
  ...
  if(!ValidaPermisoSelf(FUNC_SELF)) {  
    ...
    $tab_billing = RecibeParametroNumerico('t', True); 
	...
	switch($cl_template) {
		case TMPL_LIGA:
			if(!empty($nodo)) {
		    	...
		    	echo 
		    		"<script type='text/javascript'>
		    			location.hash = '#site/node.php?node=$nodo';
		    		</script>";
		    }
		  }
		  elseif(!empty($pagina)) {
		  	if($fg_ventana) {
		    	...
		    	echo 
		    		"<script type='text/javascript'>
		    			location.hash = '#site/content.php?page=$pagina';
	    			</script>";
		    }
		  }
		  	...
		  	if($fg_ventana) {
		    	echo "
		    	  ...
		    	  if($tab_billing==1){
                    ...
                    echo 
		    		"<script type='text/javascript'>
		    			location.hash = '#site/$ds_ruta?t=1';
	    			</script>";
                    
                }else{  
		    	echo 
		    		"<script type='text/javascript'>
		    			location.hash = '#site/$ds_ruta';
	    			</script>";
                }
		    }
		  }
