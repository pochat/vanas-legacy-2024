...
if(!ValidaPermisoSelf(FUNC_SELF)) {  
  ...
  $ds_descripcion_fra = nl2br(RecibeParametroHTML("ds_descripcion_fra"));
  ...
  if(empty($clave)){
    ...
    if($ro[0]){
      ...
      $Query='INSERT INTO k_criterio_fame (fl_criterio,fl_calificacion_criterio, ds_descripcion_fra) VALUES ('.$clave.', '.$fl_calificacion.', "'.$ds_descripcion_fra.'")';
      EjecutaInsert($Query);
    }
  }
?>