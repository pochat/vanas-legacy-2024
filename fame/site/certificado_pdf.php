<?php
  ...
  if($fg_tipo==2){
    ...
    $pdf->Image($img_file, 0, 0, 0, 0, 'PNG', '', '', false, 300, '', false, false, $border, false, false, false);
    $height = 350;
  ...
  $fullname = $ds_nombres." ".$ds_apaterno;
  ...
  // signature
  $vanasSignature = PATH_SELF_IMG_F."/diploma-vanas-signature.png";
  ...
  # Nombre del archivo
  $nombre_archivo = $ds_nombres."_".$ds_apaterno."_".$nb_programa.".pdf";
