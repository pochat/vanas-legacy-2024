...
if (!empty($nuevo)) {
  ...
  //$tabCounter = 0;
  //TabCounter correspondera a la tab qu esta pintando 
  $tabCounter = $i;
  if ($fg_error == 0) {
...
<div class="row">
  ...
  <div class="col col-xs-6 col-sm-4">
    ...
    echo "      <label>";
    FAMECampoRadio("fg_tipo_resp_$tabCounter", 'T', $fg_tipo_resp_[$tabCounter], ObtenEtiqueta(1202), True, "onchange='showContent_$tabCounter(this.value); Valida_Quiz_new_tab(" . $tabCounter . ");'");   
    echo "      </label>";
    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    echo "      <label>";
    FAMECampoRadio("fg_tipo_resp_$tabCounter", 'I',$fg_tipo_resp_[$tabCounter], ObtenEtiqueta(1203), True, "onchange='showContent_$tabCounter(this.value); Valida_Quiz_new_tab(" . $tabCounter . ");'");
    echo "      </label>";
    echo "      </div>";
    echo "  </div>";
    echo"   <input type='hidden' name='fg_tipo_preg_$tabCounter' id='fg_tipo_preg_$tabCounter' value='$fg_tipo_resp_[$tabCounter]' >";
    echo "</div>";
    ?>
  </div>
  ...
  <div id="img_based_1_<?php echo $tabCounter; ?>" <?php echo $style_1; ?>>
    <div class="col col-xs-6 col-sm-6">
      ...
      echo "<div class='smart-form'>";
      echo "<label>";
      FAMECampoRadio("fg_tipo_img_$tabCounter", 'L', $fg_tipo_img_[$tabCounter], ObtenEtiqueta(1211), True, "onchange='TipoImagen_$tabCounter(this.value);'");
      echo "</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>";
      FAMECampoRadio("fg_tipo_img_$tabCounter", 'P', $fg_tipo_img_[$tabCounter], ObtenEtiqueta(1212), True, "onchange='TipoImagen_$tabCounter(this.value);'");
      echo "</label>";
      echo "</div>";
      echo "</div>";
      //Forma_CampoOculto("fg_tipo_img_prev_$tabCounter", $fg_tipo_img_[$tabCounter]);
	  echo"<input type='hidden' name='fg_tipo_img_prev_$tabCounter' id='fg_tipo_img_prev_$tabCounter' value='$fg_tipo_img_[$tabCounter]' >";
      echo "</div>";
      ?>
    </div>
  </div>
  ...
  <div class="widget-body">
    ...
    <div id="myTabQuizCont_<?php echo $tabCounter; ?>" class="tab-content padding-10 no-border">
      <div class="tab-pane fade in active" id="tab-quiz_eng<?php echo $tabCounter; ?>">
        ...
        <div class="col col-xs-12 col-sm-5">
		  <label class="control-label"><?php echo ObtenEtiqueta(1200)."<span id='NoPreg_$tabCounter'>$tabCounter</span>"; ?></label>
		  <div class="smart-form">
          <?php 
		  
			//Forma_CampoTexto(ObtenEtiqueta(1200) . " <span id='NoPreg_$tabCounter'>$tabCounter</span>", False, "ds_pregunta_$tabCounter", $ds_pregunta_[$tabCounter], 255, 63, $err_val_pregunta_x_[$tabCounter], False, '', True, '', '', "smart-form", 'left', 'col col-sm-12', 'col col-sm-12'); 
			FAMEInputText('','ds_pregunta_'.$tabCounter.'',$ds_pregunta_[$tabCounter],false);
		  ?>
		  </div>
        </div>
        ...
        <div class="col col-xs-12 col-sm-2">
          <?php
		  echo"<input type='hidden' name='q_remaining_".$tabCounter."' id='".$q_remaining_[$tabCounter]."'  >";
		  ?>
		  <div class="smart-form">
		  <?php
		  FAMEInputText(ObtenEtiqueta(1213),'ds_quiz_'.$tabCounter.'',$valor_ini_preg[$tabCounter],false,'','',true);
        ...
        <div id="img_based_2_<?php echo $tabCounter; ?>" <?php echo $style_2; ?>>
          ...
          <div class="row">
            <div class="col col-xs-12 col-sm-3">
              <div class="smart-form">
			  <?php 
			  //Forma_CampoTexto(ObtenEtiqueta(1204) . ' 1', False, "ds_resp_1_$tabCounter", $ds_resp_1_[$tabCounter], 255, 41, $ds_resp_1_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); 
			  FAMEInputText(ObtenEtiqueta(1204).' 1','ds_resp_1_'.$tabCounter.'',$ds_resp_1_[$tabCounter],false);
			  ?>
              </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
            ...
            <div class="col col-xs-12 col-sm-2">
              ...
              FAMEInputText('','ds_grade_1_'.$tabCounter.'',$ds_grade_1_[$tabCounter],false,'onKeyPress=\"return SoloNumeros(event);\"','','',"Suma_val_resp_quiz(this.value, 'ds_grade_1_".$tabCounter."'); Valida_Quiz_new_tab(".$tabCounter.");");                                    
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-3">
			  <div class="smart-form">
              <?php 
			  //Forma_CampoTexto(ObtenEtiqueta(1204) . ' 2', False, "ds_resp_2_$tabCounter", $ds_resp_2_[$tabCounter], 255, 41, $ds_a_email_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); 
			  FAMEInputText(ObtenEtiqueta(1204).' 2',"ds_resp_2_".$tabCounter."",$ds_resp_2_[$tabCounter],false);
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
            ...
            <div class="col col-xs-12 col-sm-2">
			  ...
			  FAMEInputText('','ds_grade_2_'.$tabCounter.'',$ds_grade_2_[$tabCounter],false,'onKeyPress=\"return SoloNumeros(event);\"','','',"Suma_val_resp_quiz(this.value, 'ds_grade_2_".$tabCounter."'); Valida_Quiz_new_tab(".$tabCounter.");");                                    			  
			  ?>
			  </div>
            </div>
          </div>
          <div class="row">
            <div class="col col-xs-12 col-sm-3">
			  <div class="smart-form">
              <?php 
			  //Forma_CampoTexto(ObtenEtiqueta(1204) . ' 3', False, "ds_resp_3_$tabCounter", $ds_resp_3_[$tabCounter], 255, 41, $ds_a_email_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); 
			  FAMEInputText(ObtenEtiqueta(1204).' 3',"ds_resp_3_".$tabCounter."",$ds_resp_3_[$tabCounter],false);			  
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
            ...
            <div class="col col-xs-12 col-sm-2">
			  ...
			  FAMEInputText('','ds_grade_3_'.$tabCounter.'',$ds_grade_3_[$tabCounter],false,'onKeyPress=\"return SoloNumeros(event);\"','','',"Suma_val_resp_quiz(this.value, 'ds_grade_3_".$tabCounter."'); Valida_Quiz_new_tab(".$tabCounter.");");                                    			  
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-3">
			  <div class="smart-form">
              <?php 
			  //Forma_CampoTexto(ObtenEtiqueta(1204) . ' 4', False, "ds_resp_4_$tabCounter", $ds_resp_4_[$tabCounter], 255, 41, $ds_a_email_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); 
			   FAMEInputText(ObtenEtiqueta(1204).' 4',"ds_resp_4_".$tabCounter."",$ds_resp_4_[$tabCounter],false);
			  ?>
              </div>
			</div>
            <div class="col col-xs-12 col-sm-1">
            ...
            <div class="col col-xs-12 col-sm-2">
			  ...
			  FAMEInputText('','ds_grade_4_'.$tabCounter.'',$ds_grade_4_[$tabCounter],false,'onKeyPress=\"return SoloNumeros(event);\"','','',"Suma_val_resp_quiz(this.value, 'ds_grade_4_".$tabCounter."'); Valida_Quiz_new_tab(".$tabCounter.");");                                    			  
      ...
      <div class="tab-pane fade in " id="tab-quiz_esp<?php echo $tabCounter; ?>">
        ...
        <div class="col col-xs-12 col-sm-5">
          ...
          FAMEInputText(ObtenEtiqueta(1200)." <span id='NoPreg_esp_".$tabCounter."'>".$tabCounter."</span>","ds_pregunta_esp_".$tabCounter."",$ds_pregunta_esp_[$tabCounter],false);
        ...
        <div class="col col-xs-12 col-sm-2">
		 ...
		 <?php  echo"<input type='hidden' name='q_remaining_".$tabCounter."' id='q_remaining_".$tabCounter."' value='".$q_remaining_[$tabCounter]."'>"; ?>
		  <div class="smart-form">
          <?php
          // Forma_CampoOculto("q_remaining_$tabCounter", $q_remaining_[$tabCounter]);
          // Forma_CampoTexto(ObtenEtiqueta(1213), False, "ds_quiz_$tabCounter", $valor_ini_preg[$tabCounter], 3, 16, $ds_quiz_err_[$tabCounter], False, '', True, 'disabled', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
             FAMEInputText(ObtenEtiqueta(1213),"ds_quiz_".$tabCounter."",$valor_ini_preg[$tabCounter],false);			  
		  ?>
		  </div>
        ...
        <div id="img_based_2_esp_<?php echo $tabCounter; ?>" <?php echo $style_2; ?>>
          ...
          <div class="row">
            <div class="col col-xs-12 col-sm-3">
              ...
              FAMEInputText(ObtenEtiqueta(1204).' 1',"ds_resp_esp_1_".$tabCounter."",$ds_resp_esp_1_[$tabCounter],false);		
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
            ...
            <div class="col col-xs-12 col-sm-3">
              ...
              //Forma_CampoTexto(ObtenEtiqueta(1204) . ' 2', False, "ds_resp_esp_2_$tabCounter", $ds_resp_esp_2_[$tabCounter], 255, 41, $ds_a_email_err, False, '', True, '', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12');
               FAMEInputText(ObtenEtiqueta(1204).' 2',"ds_resp_esp_2_".$tabCounter."",$ds_resp_esp_2_[$tabCounter],false);
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
          ...
          <div class="row">
            <div class="col col-xs-12 col-sm-3">
              ...
              FAMEInputText(ObtenEtiqueta(1204).' 3',"ds_resp_esp_3_".$tabCounter."",$ds_resp_esp_3_[$tabCounter],false);
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
            ...
            <div class="col col-xs-12 col-sm-3">
              ...
              FAMEInputText(ObtenEtiqueta(1204).' 4',"ds_resp_esp_4_".$tabCounter."",$ds_resp_esp_4_[$tabCounter],false);
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
      ...
      <div class="tab-pane fade in " id="tab-quiz_fra<?php echo $tabCounter; ?>">
        ...
        <div class="col col-xs-12 col-sm-5">
          ...
          FAMEInputText(ObtenEtiqueta(1200)." <span id='NoPreg_fra_".$tabCounter."'>".$tabCounter."</span>","ds_pregunta_fra_".$tabCounter."",$ds_pregunta_fra_[$tabCounter],false);
		  ?>
		  </div>
        </div>
        <div class="col col-xs-12 col-sm-1">
        ...
        <div class="col col-xs-12 col-sm-2">
          <?php 
		  echo"<input type='hidden' name='q_remaining_".$tabCounter."' id='q_remaining_".$tabCounter."' value='".$q_remaining_[$tabCounter]."'>";
		  ?>
		  <div class="smart-form">
		  <?php
          //Forma_CampoOculto("q_remaining_$tabCounter", $q_remaining_[$tabCounter]);
        ...
        <div id="img_based_2_fra_<?php echo $tabCounter; ?>" <?php echo $style_2; ?>>
          ...
          <div class="row">
            <div class="col col-xs-12 col-sm-3">
              ...
              FAMEInputText(ObtenEtiqueta(1204).' 1','ds_resp_fra_1_'.$tabCounter.'',$ds_resp_fra_1_[$tabCounter],false);
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
            ...
            <div class="col col-xs-12 col-sm-3">
              ...
              FAMEInputText(ObtenEtiqueta(1204).' 2','ds_resp_fra_2_'.$tabCounter.'',$ds_resp_fra_2_[$tabCounter],false);
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
          ...
          <div class="row">
            <div class="col col-xs-12 col-sm-3">
				...
				<div class="smart-form">
				  ...
				  FAMEInputText(ObtenEtiqueta(1204).' 3','ds_resp_fra_3_'.$tabCounter.'',$ds_resp_fra_3_[$tabCounter],false);
				  ?>
				</div>
            </div>
            <div class="col col-xs-12 col-sm-1">
            ...
            <div class="col col-xs-12 col-sm-3">
              ...
              FAMEInputText(ObtenEtiqueta(1204).' 4','ds_resp_fra_4_'.$tabCounter.'',$ds_resp_fra_4_[$tabCounter],false);
			  ?>
			  </div>
            </div>
            <div class="col col-xs-12 col-sm-1">
    ...
    <div id="img_based_3_<?php echo $tabCounter; ?>" <?php echo $style_3; ?>>
      ...
      <div class="row">
        <div class="col col-xs-12 col-sm-4">
          <?php 
		  FAMECargaImagenDropZone(ObtenEtiqueta(1204).' 1', 'mydropzone_1_'.$tabCounter.'', "$tabCounter", $editar_[$tabCounter],$fl_quiz_pregunta_[$tabCounter], $fg_error, $ds_resp_1_[$tabCounter], "$fg_tipo_img_[$tabCounter]", "Valida_Quiz_new_tab(" . $tabCounter . ");", $fg_tipo_resp_[$tabCounter]);                    
          ?>
        </div>
        <div class="col col-xs-12 col-sm-2">
		  <label class="control-label"><strong><?php echo $var.ObtenEtiqueta(1205);?></strong> </label>
		  ...
		  //Forma_CampoTexto($var . ObtenEtiqueta(1205), False, "ds_grade_img_1_$tabCounter", $ds_grade_img_1_[$tabCounter], 3, 10, $ds_a_email_err, False, '', True, 'onkeyup="Suma_val_resp_quiz(this.value, \'ds_grade_img_1_' . $tabCounter . '\'); Valida_Quiz_new_tab(' . $tabCounter . ');"  onKeyPress="return SoloNumeros(event);"', '', "form-group", 'left', 'col col-sm-12', 'col col-sm-12'); 
		   FAMEInputText('','ds_grade_img_1_'.$tabCounter.'',$ds_grade_img_1_[$tabCounter],false,'onKeyPress=\"return SoloNumeros(event);\"','','',"Suma_val_resp_quiz(this.value, 'ds_grade_img_1_".$tabCounter."'); Valida_Quiz_new_tab(".$tabCounter.");");                                    			  				  			  			  			  			  				  
		  ?>
		  </div>
        </div>
        <div class="col col-xs-12 col-sm-4">
          <?php 
          FAMECargaImagenDropZone(ObtenEtiqueta(1204).' 2', "mydropzone_2_$tabCounter", "$tabCounter", $editar_[$tabCounter],$fl_quiz_pregunta_[$tabCounter], $fg_error, $ds_resp_2_[$tabCounter], "$fg_tipo_img_[$tabCounter]", "Valida_Quiz_new_tab(" . $tabCounter . ");", $fg_tipo_resp_[$tabCounter]);                            
          ?>
        </div>
        <div class="col col-xs-12 col-sm-2">
		  <label class="control-label"><strong><?php echo $var.ObtenEtiqueta(1205);?></strong> </label>
		  ...
		  FAMEInputText('','ds_grade_img_2_'.$tabCounter.'',$ds_grade_img_2_[$tabCounter],false,'onKeyPress=\"return SoloNumeros(event);\"','','',"Suma_val_resp_quiz(this.value, 'ds_grade_img_2_".$tabCounter."'); Valida_Quiz_new_tab(".$tabCounter.");");                                    			  				  			  			  			  			  				  
      ...
      <div class="row">
        <div class="col col-xs-12 col-sm-4">
          <?php 
          FAMECargaImagenDropZone(ObtenEtiqueta(1204).' 3', "mydropzone_3_$tabCounter", "$tabCounter", $editar_[$tabCounter],$fl_quiz_pregunta_[$tabCounter], $fg_error, $ds_resp_3_[$tabCounter], "$fg_tipo_img_[$tabCounter]", "Valida_Quiz_new_tab(" . $tabCounter . ");", $fg_tipo_resp_[$tabCounter]);                           
          ?>
        </div>
        <div class="col col-xs-12 col-sm-2">
		 <label class="control-label"><strong><?php echo $var.ObtenEtiqueta(1205);?></strong> </label>
		 <div class="smart-form">
		  ...
		  FAMEInputText('','ds_grade_img_3_'.$tabCounter.'',$ds_grade_img_3_[$tabCounter],false,'onKeyPress=\"return SoloNumeros(event);\"','','',"Suma_val_resp_quiz(this.value, 'ds_grade_img_3_".$tabCounter."'); Valida_Quiz_new_tab(".$tabCounter.");");                                    			  				  			  			  			  			  				  		
		  ?>
		  </div>
        </div>
        <div class="col col-xs-12 col-sm-4">
          <?php 
          FAMECargaImagenDropZone(ObtenEtiqueta(1204).' 4', "mydropzone_4_$tabCounter", "$tabCounter", $editar_[$tabCounter],$fl_quiz_pregunta_[$tabCounter], $fg_error, $ds_resp_4_[$tabCounter], "$fg_tipo_img_[$tabCounter]", "Valida_Quiz_new_tab(" . $tabCounter . ");", $fg_tipo_resp_[$tabCounter]); 
          ?>
        </div>
        <div class="col col-xs-12 col-sm-2">
		  <label class="control-label"><strong><?php echo $var.ObtenEtiqueta(1205);?></strong> </label>
		  ...
		  FAMEInputText('','ds_grade_img_4_'.$tabCounter.'',$ds_grade_img_4_[$tabCounter],false,'onKeyPress=\"return SoloNumeros(event);\"','','',"Suma_val_resp_quiz(this.value, 'ds_grade_img_4_".$tabCounter."'); Valida_Quiz_new_tab(".$tabCounter.");");                                    			  				  			  			  			  			  				  		
    ...
    <script>
      function MuestraPreview_<?php echo $tabCounter; ?>(tabCounter) {
        ...
        if (tipo == 'I') {
          for (inc = 1; inc <= 4; inc++) {
            document.getElementById('Img_' + inc + '_' + tabCounter).src = '/AD3M2SRC4/modules/fame/uploads/' + document.getElementById('nb_img_prev_mydropzone_' + inc + '_' + tabCounter).value;
            document.getElementById('Img2_' + inc + '_' + tabCounter).src = '/AD3M2SRC4/modules/fame/uploads/' + document.getElementById('nb_img_prev_mydropzone_' + inc + '_' + tabCounter).value;
          }
        }
        // Abrimos modal
