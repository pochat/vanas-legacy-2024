    ...
    <script>
        ...
        $.ajax({
            type: 'POST',
            url : 'site/valida_leccion_valor.php',
            async: false,
        ...
        $.ajax({
            ...
            if(data==0){
                document.getElementById('no_ses_wk').value = 0;   
            }
        ...
        $.ajax({
            type: 'POST',
            url : 'site/act_lista_criterios.php',
            async: false,
            data: 'clave='+cle,
            success: function(data) {
        ...
        $(document).ready(function() {
            $('#sortable').sortable({
                ...
                // change order in the database using Ajax
                    $.ajax({
                        url: 'site/act_ord_criterios.php?clave='+<?php echo $clave; ?>,
                        type: 'POST',
    ...
    ?>
		<input type="hidden" name="no_ter_co2" id="no_ter_co2" value="<?php echo $suma_rubric[0];?>">
	<?php         
        if(!empty($clave))
...
#            Forma_CampoSelectBD(ObtenEtiqueta(1330), False, 'fl_criterio', $Query, 0, '', True, "onchange='CambiaEstiloBtn(0, 0);'", 'left', 'col col-md-12', 'col col-md-12', '', 'cop_ru');
    ...
    <div class="col col-xs-2 col-sm-2" style="padding-left:0px; padding-right:0px; width:135px;">
        ...
        <label class="input" id="">
            <input class="form-control" id="no_val_rub" name="no_val_rub" value="<?php echo $no_val_rub; ?>" maxlength="3" size="12" type="text" <?php echo $disabled_no_val_rub; ?> onblur	="ValidaValorRubric(this.value); Suma_val_resp_quiz(this.value, 'no_val_rub');">
        </label>
		<input type="hidden" name="no_val_rub_bd" id="no_val_rub_bd" value="<?php echo $no_val_rub;?>">
    ...
    <div class="col col-xs-12 col-sm-5">
        ...
        <div class="col-sm-12"> 	
            <label class="input" id="">
			    ...
			    <input type="hidden" name="sum_val_grade" id="sum_val_grade" value="<?php echo $sum_val_grade;?>">
            </label>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" style="width:100%;">
                                            ...
                                            <?php
												...
												#Recuperamos cuntos escalas de calificacion tiene.
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo str_texto($name[0]??NULL); ?></td>
                                                <?php
                                                ...
                                                <div class="widget-body"  style="padding-top:20px; vertical-align: middle; font: bold 40px Arial; text-align: center; ">
                                                    ...
                                                    <a href="form-x-editable.html#" id="username_<?php echo $fl_criterio; ?>" data-placement="left" data-type="text" data-pk="<?php echo $fl_criterio; ?>" data-original-title="Add value"><?php echo $no_valor; ?></a>%
                                                    </div>
                                                </div>
                                                </td>
                                            </tr>
...
<script>
      ...
      $.ajax({
        type: 'POST',
        url: 'site/rubric_preview_modal.php',
