...
require("../lib/self_general.php");
 ...
 # Recibe parametros
  ...
  $fg_editar = RecibeParametroNumerico('fg_editar');
 ...
 <form class="smart-form">
    <div class="row">
      ...
      <div class="col-md-8">
		  ...
		  FAMECampoSelectBD(ObtenEtiqueta(389),'fl_idioma', $Query, $fl_idioma, 'select2', True, "", $p_valores='', $p_seleccionar_txt = 'Select', $p_seleccionar_val =0);       
		  ...
		  <input type='hidden' name='fl_leccion' id='fl_leccion' value="<?php echo $fl_leccion;?>">	  
      ...
      <section>
        ...
        <label class="textarea textarea-resizable" style="width: 100%;"> 										
          <textarea rows="8" class="custom-scroll" placeholder="WEBVTT ......" id="ds_language" name="ds_language" style="width: 100%;"><?php
