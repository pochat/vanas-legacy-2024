...
function Mark(all_comments=0, mark, post,fg_confirmacion_email=0,fg_confirmado_amigo=0,fg_mesaje_leido){
    ...
    if(all_comments==1){
      data = "all_comments="+all_comments;
        ...
        data = "fg_read_r="+mark+"&fl_gallery_comment_sp="+post+"&fg_confirmacion_email="+fg_confirmacion_email+"&fg_confirmado_amigo="+fg_confirmado_amigo+"&all_comments="+all_comments+"&fg_mesaje_leido="+fg_mesaje_leido
    }
    // ajax
    $.ajax({
      type: "POST",
      ...
      data: data,
        ...
        if(fg_chat==1){
            ...
            var new_tot=parseInt(tot_notifications)-1;
            var new_tot_msj=parseInt(no_mesajes)-1;
