<?php
  ...
  if( ($ext == 'jpg') || ($ext == "jpeg") || ($ext=='png') || ($ext=='PNG')){
    //if($ext=='jpeg')
    //echo$nb_file = "<img class='img-responsive img-center' src='".$ruta_orginal."/$nb_file'>";
	//else
 ...
 // echo $fl_gallery_post_sp." institu=".$nb_instituto." program".$nb_programa.;
