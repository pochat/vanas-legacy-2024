<?php 
  ...
  $Query="SELECT fg_gender,fg_grade,fg_educational, fg_international, fg_blocking FROM k_instituto_filtro WHERE fl_instituto=$fl_instituto ";
  ...
  $Query="SELECT fg_parent_authorization FROM c_insttituo WHERE fl_instituto=$fl_instituto ";
  $row=RecuperaValor($Query);
		...
		<div class="row">
			...
			<div class="col-md-6">
                ...
                <div class="col-md-7 text-left"><br/>
										...
										<p>Your students will see
											artwork and interact
											digitally with other
											students within this
											grade and level range.</p>
...
function GuardarFiltro(){
      var fg_grade, fg_international, fg_international1, fg_international2, fg_educational, fg_educational1, fg_educational2,fg_parent_authorization;
			if ($('#opc1').is(':checked')) {
                var fg_gender = 1;
            } else {
                var fg_gender = 2;
