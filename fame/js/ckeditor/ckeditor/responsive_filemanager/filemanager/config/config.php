...
if (session_id() == '') session_start();
  ...
  $ruta_archivos_instituto=$_SERVER["DOCUMENT_ROOT"]."/../../../../../site/uploads/".$fl_instituto;
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/fame/site/uploads/'.$fl_instituto.'/attachments/',

	/* ICH: RUTA DONDE GUARDA IMG
	|--------------------------------------------------------------------------
	...
	|
	*/
	/*define la ruta de los uploads*/
	'current_path' => $_SERVER["DOCUMENT_ROOT"].'/fame/site/uploads/'.$fl_instituto.'/attachments/',
