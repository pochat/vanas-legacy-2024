...
function com_install(){
	...
	echo "<H3>Installing Offlajn AJAX Live Search component and module Success</h3>"; 
...
class Installer extends JObject {
    ...
    $pkg_path = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_universal_ajax_live_search'.DS.'extensions'.DS.$this->vers.DS;
    $pkgs = array( 
