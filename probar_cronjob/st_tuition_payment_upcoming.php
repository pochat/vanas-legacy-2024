<?php
	...
	#require '../lib/com_email_func.inc.php';
...
#				$ds_template_html->getElementById("login-redirect")->href = $base_url."/modules/students_new/index.php#ajax/payment_history.php";				
        ...
        if(!empty($email))
          ...
          $emails = "N";
        EjecutaQuery("INSERT INTO k_envio_cronjob(fl_usuario, ds_mensaje, fe_cron, fg_enviado, fl_template) VALUES(".$fl_alumno.", '".str_html_bd($ds_template_html)."', NOW(), '".$emails."', 17)");
			}
		}
	}
	...
	#Notificacviones extras, personalizadas.
