<?php
  ...
  define('PATH_ALU_WORKS',    PATH_ALU . '/works_files');
  define('PATH_ALU_IMAGES',   PATH_ALU . '/images');
  define('PATH_ALU_IMAGES_F', PATH_CAMPUS_F . '/students/images');
  define('PATH_ALU_WORKS_F',  PATH_CAMPUS_F . '/students/works_files');
  ...
  define('SP_FLASH_FAME',     PATH_SELF_JS . '/flowplayer');
  define('SP_FAME_VIDEOS',     SP_HOME . '/vanas_videos/fame/lessons');
  define('PATH_FAME_TMP', PATH_SELF. '/tmp');
  
  # Rutas fisicas self_pace
  define('PATH_SELF_F', $_SERVER['DOCUMENT_ROOT'].'/fame');
  define('PATH_SELF_SITE_F', PATH_SELF_F. '/site');
  define('PATH_SELF_QUERY_F', PATH_SELF_F. '/Query');
  define('PATH_SELF_LIB_F', PATH_SELF_F. '/lib');
  define('PATH_SELF_JS_F', PATH_SELF_F. '/js');
  define('PATH_SELF_CSS_F', PATH_SELF_F. '/css');
  define('PATH_SELF_IMG_F', PATH_SELF_F. '/img');
  define('CLASSES',PATH_SELF_F. '/class/');
  define('PATH_SELF_UPLOADS_F', PATH_SELF_SITE_F. '/uploads'); // Archivos de los usuarios

  
  # Rutas ffmpeg Fame
  #define('FFMPEG_FAME', '/var/www/html/vanas/fame/ffmpeg/ffmpeg');
  define('FFMPEG_FAME', '/usr/bin/ffmpeg');
  
  # Variables globales para Fame
  define('CARPETA_USER', 'USER_');
  
  # size images uploads
  define('IMG_REGULAR', 280);
  define('IMG_THUMBS', 90);
  define('IMG_SKETCHE', 720);
  define('IMG_BTHUMBS',300);
  
  # Valores de las acciones self pace
  define('ADD_STD', 1);
  define('IMP_STD', 2);
  define('ADD_MAE', 3);
  define('IMP_MAE', 4);
  ...
  define('ASG_COURSE', 9);
  define('CAM_GROUP', 10);
  define('DESASIGNAR_COURSE', 11);
  define('PAUSE_COURSE', 12);
  define('VERIFCA_USUARIO_PROGRAMA', 20);
  define('CHANGE_PERFIL', 21);
  define('ASSESSMENT', 22);
  define('ASSIGN_MYSELF', 23);
  define('RESEND_EMAIL_INVITATION', 24);
  define('ASG_TEACHER', 25);
  define('CSF_RESEND_EMAIL_INVITACION', 44);

 
  #Valores para definir el motivo de pago en Strippe
  define('PAGO_NEW_PLAN', 1);
  define('PAGO_ADD_LICENCES', 2);
  define('PAGO_CAMBIO_PLAN', 3);
  define('PAGO_CANCELACION_PLAN', 4);
  define('PAGO_RENOVACION_PLAN', 5);
  ...
  # variables de fame
  define('FAME_TRIAL_EXP',   SP_HOME. '/login.php?err=8');
