...
function str_texto($p_cadena) {
  ...
  $cadena = str_replace("�", "&#232;", $cadena);
  $cadena = str_replace("�", "&#234;", $cadena);
  $cadena = str_replace("�", "&#235;", $cadena);
  $cadena = str_replace("�", "&#236;", $cadena);
  $cadena = str_replace("�", "&#238;", $cadena);
  $cadena = str_replace("�", "&#239;", $cadena);
  $cadena = str_replace("�", "&#242;", $cadena);
  $cadena = str_replace("�", "&#244;", $cadena);
  $cadena = str_replace("�", "&#245;", $cadena);
  $cadena = str_replace("�", "&#246;", $cadena);
  $cadena = str_replace("�", "&#249;", $cadena);
  $cadena = str_replace("�", "&#251;", $cadena);
  $cadena = str_replace("�", "&#252;", $cadena);
...
function genera_documento($clave, $opc, $correo=False, $firma=False, $no_contrato=1) {
  ...
  $Query .= "nb_programa, fl_template, ds_duracion, nb_periodo, a.fl_programa, b.fg_tax_rate, a.ds_add_country, b.fg_fulltime ";
  ...
  $Query .= "ds_firma_padre, ds_a_email ";
  ...
  $cadena = str_replace("#pg_appfee#", "$".number_format($app_fee,2), $cadena);               #Program application fee 
  $cadena = str_replace("#pg_tuition#", "$".number_format($tuition,2), $cadena);              #Program tuition 
  $cadena = str_replace("#pg_ds_other_cost#", "".$ds_costos_ad, $cadena);                           #Program other cost description
  $cadena = str_replace("#pg_other_cost#", "$".number_format($no_costos_ad,2), $cadena);      #Program other cost 
  $cadena = str_replace("#pg_ds_cost_discount#", "".$ds_descuento, $cadena);                        #Program discount description. 
  $cadena = str_replace("#pg_cost_discount#", "$".number_format($no_descuento,2), $cadena);   #Program discount. 
  $cadena = str_replace("#pg_total_tuition#", "$".number_format($mn_tot_tuition,2), $cadena); #Program total tuition cost 
  $cadena = str_replace("#pg_total_cost#", "$".number_format($mn_tot_program,2), $cadena);    #Program total cost 
  ...
  $total_costs = $mn_tot_program + $app_fee_tax + $tuition_fee_tax;
  # Remplazamos los valores del app fee tax y el tuition fee tax
  $cadena = str_replace("#app_fee_tax#", "$".number_format($app_fee_tax,2), $cadena);    #App fee tax
  $cadena = str_replace("#tuition_fee_tax#", "$".number_format($tuition_fee_tax,2), $cadena);    #Tuition fee tax  
  $cadena = str_replace("#total_costs#", "$".number_format($total_costs,2), $cadena);    # Total costs
  switch ($opc_pago)
  {
    case 1: 
      $opc_a = "X";
  ...
  $cadena = str_replace("#py_dueoptionA#", "$".number_format($amount_due_a,2), $cadena);      #Payment Amount Due option A 
  $cadena = str_replace("#py_dueoptionB#", "$".number_format($amount_due_b,2), $cadena);      #Payment Amount Due option B 
  $cadena = str_replace("#py_dueoptionC#", "$".number_format($amount_due_c,2), $cadena);      #Payment Amount Due option C 
  $cadena = str_replace("#py_dueoptionD#", "$".number_format($amount_due_d,2), $cadena);      #Payment Amount Due option D 
  $cadena = str_replace("#py_paidoptionA#", "$".number_format($amount_paid_a,2), $cadena);    #Payment Amount Paid option A 
  $cadena = str_replace("#py_paidoptionB#", "$".number_format($amount_paid_b,2), $cadena);    #Payment Amount Paid option B 
  $cadena = str_replace("#py_paidoptionC#", "$".number_format($amount_paid_c,2), $cadena);    #Payment Amount Paid option C 
  $cadena = str_replace("#py_paidoptionD#", "$".number_format($amount_paid_d,2), $cadena);    #Payment Amount Paid option D
  if($firma)
    $fecha = date("M j, Y");
  else
  {
